...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'HMDARecord', fields ['action_taken']
        db.create_index(u'hmda_hmdarecord', ['action_taken'])
    ...
    def backwards(self, orm):
        ...
        # Removing index on 'HMDARecord', fields ['action_taken']
        db.delete_index(u'hmda_hmdarecord', ['action_taken'])
