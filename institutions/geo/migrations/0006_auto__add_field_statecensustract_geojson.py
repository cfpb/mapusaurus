...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StateCensusTract.geojson'
        db.add_column(u'geo_statecensustract', 'geojson',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StateCensusTract.geojson'
        db.delete_column(u'geo_statecensustract', 'geojson')
