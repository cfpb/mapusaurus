...
var Mapusaurus = {
    ...
    initialize: function(map) {
        ...
        $("#style-selector").on("change", function() {
            ...
            var action_taken, action_taken_value = $("#action-taken-selector").val();
...
$(document).ready(function() {
    setMapHeight(), $(window).resize(function() {
        setMapHeight();
    });
    window.location.href;
    $("#take-screenshot").click(function(ev) {
        ev.preventDefault(), vex.dialog.alert({
            message: '<h2>Export Map</h2><p id="screenshot-placeholder">Loading map...</p>'
