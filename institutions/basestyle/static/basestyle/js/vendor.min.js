 ...
 * Version: 0.1.0
 * Last modified: 2014-09-16 8:37:29 PM
...
!function(global, factory) {
    ...
    $.fn.expandable = function() {
        return $(this).each(function() {
            var $this = $(this), $target = $this.find(".expandable_target"), $content = $this.find(".expandable_content");
            ...
            $target.on("click", function(ev) {
                ...
                $target.attr("aria-pressed", "false"), duration = $.fn.expandable.calculateCollapseDuration($content.height())) : ($content.attr("aria-expanded", "true"), 
                $target.attr("aria-pressed", "true"), duration = $.fn.expandable.calculateExpandDuration($content.height())), 
                $this.toggleClass("expandable__expanded"), $content.slideToggle({
                    duration: duration,
                    easing: "easeOutExpo"
                });
            });
