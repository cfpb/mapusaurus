 ...
 * Version: 0.1.0
 * Last modified: 2014-08-07 5:54:23 PM
    ...
    $(function() {
        $(".expandable").each(function() {
            ...
            $target.on("click", function(ev) {
                ...
                $target.attr("aria-pressed", "false")) : ($content.attr("aria-expanded", "true"), 
                $target.attr("aria-pressed", "true")), $this.toggleClass("expandable__expanded"), 
                $content.slideToggle({
                    duration: 400,
                    easing: "easeOutExpo"
                });
