...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Census2010HispanicOrigin.geoid'
        db.alter_column(u'censusdata_census2010hispanicorigin', 'geoid_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['geo.StateCensusTract'], to_field='geoid', unique=True, primary_key=True))

        # Changing field 'Census2010Race.geoid'
        db.alter_column(u'censusdata_census2010race', 'geoid_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['geo.StateCensusTract'], to_field='geoid', unique=True, primary_key=True))

        # Changing field 'Census2010Households.geoid'
        db.alter_column(u'censusdata_census2010households', 'geoid_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['geo.StateCensusTract'], to_field='geoid', unique=True, primary_key=True))

        # Changing field 'Census2010Age.geoid'
        db.alter_column(u'censusdata_census2010age', 'geoid_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['geo.StateCensusTract'], to_field='geoid', unique=True, primary_key=True))

        # Changing field 'Census2010Sex.geoid'
        db.alter_column(u'censusdata_census2010sex', 'geoid_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['geo.StateCensusTract'], to_field='geoid', unique=True, primary_key=True))

        # Changing field 'Census2010RaceStats.geoid'
        db.alter_column(u'censusdata_census2010racestats', 'geoid_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['geo.StateCensusTract'], to_field='geoid', unique=True, primary_key=True))
    ...
    models = {
        u'censusdata.census2010age': {
            ...
            'geoid': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['geo.Geo']", 'primary_key': 'True'}),
