!function(a, b) {
    ...
    $.fn.expandable = function() {
        return $(this).each(function() {
            var $this = $(this), $target = $this.find(".expandable_target"), $content = $this.find(".expandable_content"), $groupParent = $this.parents(".expandable-group"), accordion = $groupParent.length > 0 && $groupParent.data("accordion");
            if (accordion) var $siblings = $this.siblings(".expandable");
            $target.attr("aria-controls", $content.attr("id")), $this.hasClass("expandable__expanded") ? ($content.css("display", "block"), 
            $content.attr("aria-expanded", "true"), $target.attr("aria-pressed", "true")) : ($content.css("display", "none"), 
            $content.attr("aria-expanded", "false"), $target.attr("aria-pressed", "false")), 
            $target.on("click", function(ev) {
                var duration;
                ev.preventDefault(), ev.stopPropagation(), "true" === $target.attr("aria-pressed") ? ($content.attr("aria-expanded", "false"), 
                $target.attr("aria-pressed", "false"), duration = $.fn.expandable.calculateCollapseDuration($content.height())) : (accordion && ($siblings.children(".expandable_content").attr("aria-expanded", "false"), 
                $siblings.children(".expandable_target").attr("aria-pressed", "false"), $siblings.removeClass("expandable__expanded"), 
                $siblings.children(".expandable_content").slideUp({
                    duration: 500,
                    easing: "easeOutExpo"
                })), $content.attr("aria-expanded", "true"), $target.attr("aria-pressed", "true"), 
                duration = $.fn.expandable.calculateExpandDuration($content.height())), $this.toggleClass("expandable__expanded"), 
                $content.slideToggle({
                    duration: duration,
                    easing: "easeOutExpo"
                });
    ...
    a.extend({
        tablesorter: new function() {
            ...
            function e(c, d, e, f) {
                for (var g, h, i = c.config, j = u.parsers.length, k = !1, l = "", m = !0; "" === l && m; ) e++, 
                d[e] ? (k = d[e].cells[f], l = u.getElementText(i, k, f), h = a(k), c.config.debug && b("Checking if value was empty on row " + e + ", column: " + f + ': "' + l + '"')) : m = !1;
                for (;--j >= 0; ) if (g = u.parsers[j], g && "text" !== g.id && g.is && g.is(l, c, k, h)) return g;
            ...
            function f(a) {
                ...
                for (o.debug && (n = new Date(), b("Detecting parsers for each column")), f = {
                    ...
                    if (d = p[q].rows, d.length) for (g = o.columns, h = 0; g > h; h++) i = o.$headers.filter('[data-column="' + h + '"]:last'), 
                    j = u.getColumnData(a, o.headers, h), m = u.getParserById(u.getData(i, j, "extractor")), 
                    l = u.getParserById(u.getData(i, j, "sorter")), k = "false" === u.getData(i, j, "parser"), 
                    ...
                    k && (l = u.getParserById("no-parser")), m || (m = !1), l || (l = e(a, d, -1, h)), 
                ...
                o.debug && (b(r ? r : "No parsers detected"), c("Completed detecting parsers", n)), 
                o.parsers = f.parsers, o.extractors = f.extractors;
            }
            function g(d) {
                ...
                for (r.debug && (n = new Date()), r.showProcessing && u.isProcessing(d, !0), k = 0; k < s.length; k++) {
                    for (q = [], e = r.cache[k] = {
                        normalized: []
                    }, o = s[k] && s[k].rows.length || 0, i = 0; o > i; ++i) if (p = {
                        child: [],
                        raw: []
                    }, l = a(s[k].rows[i]), m = [], l.hasClass(r.cssChildRow) && 0 !== i) f = e.normalized.length - 1, 
                    e.normalized[f][r.columns].$row = e.normalized[f][r.columns].$row.add(l), l.prev().hasClass(r.cssChildRow) || l.prev().addClass(u.css.cssHasChild), 
                    p.child[f] = a.trim(l[0].textContent || l.text() || ""); else {
                        for (p.$row = l, p.order = i, j = 0; j < r.columns; ++j) "undefined" != typeof v[j] ? (f = u.getElementText(r, l[0].cells[j], j), 
                        p.raw.push(f), g = "undefined" == typeof t[j].id ? f : t[j].format(f, d, l[0].cells[j], j), 
                        h = "no-parser" === v[j].id ? "" : v[j].format(g, d, l[0].cells[j], j), m.push(r.ignoreCase && "string" == typeof h ? h.toLowerCase() : h), 
            ...
            function h(a, b) {
                ...
                for (l.debug && (k = new Date()), j = 0; j < n.length; j++) if (g = n.eq(j), g.length) {
                    for (h = u.processTbody(a, g, !0), e = p[j].normalized, f = e.length, i = 0; f > i; i++) o.push(e[i][l.columns].$row), 
                    l.appender && (!l.pager || l.pager.removeRows && m.pager_removeRows || l.pager.ajax) || h.append(e[i][l.columns].$row);
                    u.processTbody(a, h, !1);
                }
                l.appender && l.appender(a, o), l.debug && c("Rebuilt table", k), b || l.appender || u.applyWidget(a), 
            ...
            function j(d) {
                ...
                n.headerList = [], n.headerContent = [], n.debug && (m = new Date()), n.columns = u.computeColumnIndex(n.$table.children("thead, tfoot").children("tr")), 
                h = n.cssIcon ? '<i class="' + (n.cssIcon === u.css.icon ? u.css.icon : n.cssIcon + " " + u.css.icon) + '"></i>' : "", 
                n.$headers = a(a.map(a(d).find(n.selectorHeaders), function(b, c) {
                    return f = a(b), f.parent().hasClass(n.cssIgnoreRow) ? void 0 : (e = u.getColumnData(d, n.headers, c, !0), 
                    n.headerContent[c] = f.html(), "" === n.headerTemplate || f.find("." + u.css.headerIn).length || (j = n.headerTemplate.replace(/\{content\}/g, f.html()).replace(/\{icon\}/g, f.find("." + u.css.icon).length ? "" : h), 
                    n.onRenderTemplate && (g = n.onRenderTemplate.apply(f, [ c, j ]), g && "string" == typeof g && (j = g)), 
                    f.html('<div class="' + u.css.headerIn + '">' + j + "</div>")), n.onRenderHeader && n.onRenderHeader.apply(f, [ c, n, n.$table ]), 
                    b.column = parseInt(f.attr("data-column"), 10), b.order = i(u.getData(f, e, "sortInitialOrder") || n.sortInitialOrder) ? [ 1, 0, 2 ] : [ 0, 1, 2 ], 
                    b.count = -1, b.lockedOrder = !1, k = u.getData(f, e, "lockedOrder") || !1, "undefined" != typeof k && k !== !1 && (b.order = b.lockedOrder = i(k) ? [ 1, 1, 1 ] : [ 0, 0, 0 ]), 
                    f.addClass(u.css.header + " " + n.cssHeader), n.headerList[c] = b, f.parent().addClass(u.css.headerRow + " " + n.cssHeaderRow).attr("role", "row"), 
                    n.tabIndex && f.attr("tabindex", 0), b);
            ...
            function l(b) {
                ...
                f.$headers.each(function(g, h) {
                    d = a(h), e = u.getColumnData(b, f.headers, g, !0), c = "false" === u.getData(h, e, "sorter") || "false" === u.getData(h, e, "parser"), 
                    h.sortDisabled = c, d[c ? "addClass" : "removeClass"]("sorter-false").attr("aria-disabled", "" + c), 
            ...
            function m(b) {
                ...
                for (f.$headers.removeClass(j.join(" ")).addClass(i).attr("aria-sort", "none").find("." + f.cssIcon).removeClass(k.join(" ")).addClass(k[2]), 
                d = 0; h > d; d++) if (2 !== g[d][1] && (c = f.$headers.not(".sorter-false").filter('[data-column="' + g[d][0] + '"]' + (1 === h ? ":last" : "")), 
                c.length)) {
                ...
                f.$headers.not(".sorter-false").each(function() {
                    var b = a(this), c = this.order[(this.count + 1) % (f.sortReset ? 3 : 2)], d = a.trim(b.text()) + ": " + u.language[b.hasClass(u.css.sortAsc) ? "sortAsc" : b.hasClass(u.css.sortDesc) ? "sortDesc" : "sortNone"] + u.language[0 === c ? "nextAsc" : 1 === c ? "nextDesc" : "nextNone"];
                    b.attr("aria-label", d);
                });
            }
            function n(b, c) {
                ...
                i.sortList = [], a.each(j, function(b, c) {
                    if (g = parseInt(c[0], 10), f = i.$headers.filter('[data-column="' + g + '"]:last')[0]) {
                        ...
                        h = 0 === b ? e : h, d = [ g, parseInt(e, 10) || 0 ], i.sortList.push(d), e = a.inArray(d[1], f.order), 
            ...
            function p(b, c, d) {
                ...
                if (n.trigger("sortStart", b), c.count = d[k.sortResetKey] ? 2 : (c.count + 1) % (k.sortReset ? 3 : 2), 
                k.sortRestart && (f = c, k.$headers.each(function() {
                    ...
                    if (i = c.order[c.count], 2 > i && (k.sortList.push([ f, i ]), c.colSpan > 1)) for (g = 1; g < c.colSpan; g++) k.sortList.push([ f + g, i ]);
                } else {
                    if (k.sortAppend && k.sortList.length > 1) for (g = 0; g < k.sortAppend.length; g++) j = u.isValueInArray(k.sortAppend[g][0], k.sortList), 
                    j >= 0 && k.sortList.splice(j, 1);
                    if (u.isValueInArray(f, k.sortList) >= 0) for (g = 0; g < k.sortList.length; g++) j = k.sortList[g], 
                    i = k.$headers.filter('[data-column="' + j[0] + '"]:last')[0], j[0] === f && (j[1] = i.order[c.count], 
                    2 === j[1] && (k.sortList.splice(g, 1), i.count = -1)); else if (i = c.order[c.count], 
                    2 > i && (k.sortList.push([ f, i ]), c.colSpan > 1)) for (g = 1; g < c.colSpan; g++) k.sortList.push([ f + g, i ]);
                }
            ...
            function q(a) {
                ...
                if (!q.serverSideSorting && !d(q.cache)) {
                    for (q.debug && (h = new Date()), e = 0; v > e; e++) i = q.cache[e].colMax, j = q.cache[e].normalized, 
                    j.sort(function(c, d) {
                        for (b = 0; t > b; b++) {
                            if (g = s[b][0], k = s[b][1], p = 0 === k, q.sortStable && c[g] === d[g] && 1 === t) return c[q.columns].order - d[q.columns].order;
                            if (f = /n/i.test(o(q.parsers, g)), f && q.strings[g] ? (f = "boolean" == typeof q.string[q.strings[g]] ? (p ? 1 : -1) * (q.string[q.strings[g]] ? -1 : 1) : q.strings[g] ? q.string[q.strings[g]] || 0 : 0, 
                            l = q.numberSorter ? q.numberSorter(c[g], d[g], p, i[g], a) : u["sortNumeric" + (p ? "Asc" : "Desc")](c[g], d[g], f, i[g], g, a)) : (m = p ? c : d, 
                            n = p ? d : c, l = "function" == typeof r ? r(m[g], n[g], p, g, a) : "object" == typeof r && r.hasOwnProperty(g) ? r[g](m[g], n[g], p, g, a) : u["sortNatural" + (p ? "Asc" : "Desc")](c[g], d[g], g, a, q)), 
                            l) return l;
                        }
            ...
            function t(b) {
                var c = b.config, e = c.$table, i = "sortReset update updateRows updateCell updateAll addRows updateComplete sorton appendCache updateCache applyWidgetId applyWidgets refreshWidgets destroy mouseup mouseleave ".split(" ").join(c.namespace + " ");
                e.unbind(i.replace(/\s+/g, " ")).bind("sortReset" + c.namespace, function(d, e) {
                    ...
                    a.stopPropagation(), b.isUpdating = !0, u.refreshWidgets(b, !0, !0), j(b), u.bindEvents(b, c.$headers, !0), 
                    t(b), k(b, d, e);
                    ...
                    f = n[0], m.length && o >= 0 && (k = m.eq(o).find("tr").index(p), l = n.index(), 
                    c.cache[o].normalized[k][c.columns].$row = p, j = "undefined" == typeof c.extractors[l].id ? u.getElementText(c, f, l) : c.extractors[l].format(u.getElementText(c, f, l), b, f, l), 
                    i = "no-parser" === c.parsers[l].id ? "" : c.parsers[l].format(j, b, f, l), c.cache[o].normalized[k][l] = c.ignoreCase && "string" == typeof i ? i.toLowerCase() : i, 
                    "numeric" === (c.parsers[l].type || "").toLowerCase() && (c.cache[o].colMax[l] = Math.max(Math.abs(i) || 0, c.cache[o].colMax[l] || 0)), 
                    i = "undefined" !== g ? g : c.resort, i !== !1 ? s(c, i, h) : (a.isFunction(h) && h(b), 
                    c.$table.trigger("updateComplete", c.table)));
                }).bind("addRows" + c.namespace, function(e, g, h, i) {
                    if (e.stopPropagation(), b.isUpdating = !0, d(c.cache)) l(b), k(b, h, i); else {
                        g = a(g).attr("role", "row");
                        ...
                        for (c.parsers && c.parsers.length || f(b), j = 0; t > j; j++) {
                            ...
                            }, m = 0; n > m; m++) o = "undefined" == typeof c.extractors[m].id ? u.getElementText(c, g[j].cells[m], m) : c.extractors[m].format(u.getElementText(c, g[j].cells[m], m), b, g[j].cells[m], m), 
                            p = "no-parser" === c.parsers[m].id ? "" : c.parsers[m].format(o, b, g[j].cells[m], m), 
                            r[m] = c.ignoreCase && "string" == typeof p ? p.toLowerCase() : p, "numeric" === (c.parsers[m].type || "").toLowerCase() && (c.cache[v].colMax[m] = Math.max(Math.abs(r[m]) || 0, c.cache[v].colMax[m] || 0));
                    ...
                    var k = b.config;
                    c.stopPropagation(), e.trigger("sortStart", this), n(b, f), m(b), k.delayInit && d(k.cache) && g(b), 
                    e.trigger("sortBegin", this), q(b), h(b, j), e.trigger("sortEnd", this), u.applyWidget(b), 
                    a.isFunction(i) && i(b);
                    ...
                    u.removeWidget(b, !0, !1), c = a.extend(!0, u.defaults, c.originalSettings), b.hasInitialized = !1, 
                    u.setup(b, c);
                });
            }
            var u = this;
            u.version = "2.20.1", u.parsers = [], u.widgets = [], u.defaults = {
                theme: "default",
                widthFixed: !1,
                showProcessing: !1,
                ...
                return this.each(function() {
                    var c = this, d = a.extend(!0, {}, u.defaults, b);
                ...
                var e = "", h = a(c), i = a.metadata;
                c.hasInitialized = !1, c.isProcessing = !0, c.config = d, a.data(c, "tablesorter", d), 
                d.debug && a.data(c, "startoveralltimer", new Date()), d.supportsDataObject = function(a) {
                    ...
                    top: !0,
                    bottom: !1
                }, d.emptyTo = d.emptyTo.toLowerCase(), d.stringTo = d.stringTo.toLowerCase(), /tablesorter\-/.test(h.attr("class")) || (e = "" !== d.theme ? " tablesorter-" + d.theme : ""), 
                d.table = c, d.$table = h.addClass(u.css.table + " " + d.tableClass + e).attr("role", "grid"), 
                d.$headers = h.find(d.selectorHeaders), d.namespace = d.namespace ? "." + d.namespace.replace(/\W/g, "") : ".tablesorter" + Math.random().toString(16).slice(2), 
                d.$table.children().children("tr").attr("role", "row"), d.$tbodies = h.children("tbody:not(." + d.cssInfoBlock + ")").attr({
                    "aria-live": "polite",
                    "aria-relevant": "all"
                ...
                j(c), u.fixColumnWidth(c), f(c), d.totalRows = 0, d.delayInit || g(c), u.bindEvents(c, d.$headers, !0), 
                t(c), d.supportsDataObject && "undefined" != typeof h.data().sortlist ? d.sortList = h.data().sortlist : i && h.metadata() && h.metadata().sortlist && (d.sortList = h.metadata().sortlist), 
                u.applyWidget(c, !0), d.sortList.length > 0 ? h.trigger("sorton", [ d.sortList, {}, !d.initWidgets, !0 ]) : (m(c), 
                d.initWidgets && u.applyWidget(c, !1)), d.showProcessing && h.unbind("sortBegin" + d.namespace + " sortEnd" + d.namespace).bind("sortBegin" + d.namespace + " sortEnd" + d.namespace, function(a) {
                    clearTimeout(d.processTimer), u.isProcessing(c), "sortBegin" === a.type && (d.processTimer = setTimeout(function() {
                        u.isProcessing(c, !0);
                    }, 500));
                }), c.hasInitialized = !0, c.isProcessing = !1, d.debug && u.benchmark("Overall initialization time", a.data(c, "startoveralltimer")), 
                h.trigger("tablesorter-initialized", c), "function" == typeof d.initialized && d.initialized(c);
            }, u.fixColumnWidth = function(b) {
                b = a(b)[0];
                var c, d, e = b.config, f = e.$table.children("colgroup");
                f.length && f.hasClass(u.css.colgroup) && f.remove(), e.widthFixed && 0 === e.$table.children("colgroup").length && (f = a('<colgroup class="' + u.css.colgroup + '">'), 
                c = e.$table.width(), e.$tbodies.find("tr:first").children(":visible").each(function() {
                ...
                if ("undefined" != typeof c && null !== c) {
                    ...
                    for (h in c) if ("string" == typeof h && (g = j.filter('[data-column="' + d + '"]:last').filter(h).add(j.filter('[data-column="' + d + '"]:last').find(h)), 
                    g.length)) return c[h];
                }
                ...
                for (c = 0; c < b.length; c++) for (i = b[c].cells, d = 0; d < i.length; d++) {
                    for (h = i[d], g = a(h), j = h.parentNode.rowIndex, k = j + "-" + g.index(), l = h.rowSpan || 1, 
                    m = h.colSpan || 1, "undefined" == typeof p[j] && (p[j] = []), e = 0; e < p[j].length + 1; e++) if ("undefined" == typeof p[j][e]) {
                        n = e;
                        break;
                    }
                    for (q[k] = n, r = Math.max(n, r), g.attr({
                        "data-column": n
                    }), e = j; j + l > e; e++) for ("undefined" == typeof p[e] && (p[e] = []), o = p[e], 
                    f = n; n + m > f; f++) o[f] = "x";
                }
                return r + 1;
            }, u.isProcessing = function(b, c, d) {
                b = a(b);
                var e = b[0].config, f = d || b.find("." + u.css.header);
                ...
                b = a(b)[0];
                var e;
                return d ? (b.isProcessing = !0, c.before('<span class="tablesorter-savemyplace"/>'), 
                e = a.fn.detach ? c.detach() : c.remove()) : (e = a(b).find("span.tablesorter-savemyplace"), 
                c.insertAfter(e), e.remove(), void (b.isProcessing = !1));
                ...
                e !== !0 && (h.$extraHeaders = h.$extraHeaders ? h.$extraHeaders.add(c) : c), c.find(h.selectorSort).add(c.filter(h.selectorSort)).unbind("mousedown mouseup sort keyup ".split(" ").join(h.namespace + " ").replace(/\s+/g, " ")).bind("mousedown mouseup sort keyup ".split(" ").join(h.namespace + " "), function(e, i) {
                    ...
                    if (!(1 !== (e.which || e.button) && !/sort|keyup/.test(l) || "keyup" === l && 13 !== e.which || "mouseup" === l && i !== !0 && new Date().getTime() - f > 250)) {
                        ...
                        /(input|select|button|textarea)/i.test(e.target.tagName) || k.hasClass(h.cssNoSort) || k.parents("." + h.cssNoSort).length > 0 || k.parents("button").length > 0) return !h.cancelSelection;
                        h.delayInit && d(h.cache) && g(b), j = a.fn.closest ? a(this).closest("th, td")[0] : /TH|TD/.test(this.tagName) ? this : a(this).parents("th, td")[0], 
                        j = h.$headers[c.index(j)], j.sortDisabled || p(b, j, e);
                    }
                ...
                if (b = a(b)[0], b.hasInitialized) {
                    ...
                    f.trigger("applyWidgetId", [ "zebra" ])), h.find("tr").not(i).remove(), e = "sortReset update updateAll updateRows updateCell addRows updateComplete sorton appendCache updateCache " + "applyWidgetId applyWidgets refreshWidgets destroy mouseup mouseleave keypress sortBegin sortEnd resetToLoadState ".split(" ").join(g.namespace + " "), 
                    f.removeData("tablesorter").unbind(e.replace(/\s+/g, " ")), g.$headers.add(j).removeClass([ u.css.header, g.cssHeader, g.cssAsc, g.cssDesc, u.css.sortAsc, u.css.sortDesc, u.css.sortNone ].join(" ")).removeAttr("data-column").removeAttr("aria-label").attr("aria-disabled", "true"), 
                    i.find(g.selectorSort).unbind("mousedown mouseup keypress ".split(" ").join(g.namespace + " ").replace(/\s+/g, " ")), 
                    u.restoreHeaders(b), f.toggleClass(u.css.table + " " + g.tableClass + " tablesorter-" + g.theme, c === !1), 
                    b.hasInitialized = !1, delete b.config.cache, "function" == typeof d && d(b);
                }
            }, u.regex = {
                ...
                for (c = a.replace(k.chunk, "\\0$1\\0").replace(k.chunks, "").split("\\0"), e = b.replace(k.chunk, "\\0$1\\0").replace(k.chunks, "").split("\\0"), 
                j = Math.max(c.length, e.length), i = 0; j > i; i++) {
                    if (g = isNaN(c[i]) ? c[i] || 0 : parseFloat(c[i]) || 0, h = isNaN(e[i]) ? e[i] || 0 : parseFloat(e[i]) || 0, 
                    isNaN(g) !== isNaN(h)) return isNaN(g) ? 1 : -1;
                ...
                isNaN(b) && (b = u.getTextValue(b, c, d)), a - b);
            }, u.sortNumericDesc = function(a, b, c, d, e, f) {
                if (a === b) return 0;
                var g = f.config, h = g.string[g.empties[e] || g.emptyTo];
                return "" === a && 0 !== h ? "boolean" == typeof h ? h ? -1 : 1 : h || 1 : "" === b && 0 !== h ? "boolean" == typeof h ? h ? 1 : -1 : -h || -1 : (isNaN(a) && (a = u.getTextValue(a, c, d)), 
                isNaN(b) && (b = u.getTextValue(b, c, d)), b - a);
                ...
                if (u.characterRegex.test(a)) for (b in d) "string" == typeof b && (a = a.replace(u.characterRegexArray[b], b));
                return a;
                ...
                for (b = 0; c > b; b++) if (u.parsers[b].id.toLowerCase() === a.toString().toLowerCase()) return u.parsers[b];
                return !1;
                ...
                for (b = 0; d > b; b++) if (c = u.widgets[b], c && c.hasOwnProperty("id") && c.id.toLowerCase() === a.toLowerCase()) return c;
            }, u.applyWidget = function(b, d, e) {
                b = a(b)[0];
                var f, g, h, i, j = b.config, k = j.widgetOptions, l = " " + j.table.className + " ", m = [];
                d !== !1 && b.hasInitialized && (b.isApplyingWidgets || b.isUpdating) || (j.debug && (f = new Date()), 
                i = new RegExp("\\s" + j.widgetClass.replace(/\{name\}/i, "([\\w-]+)") + "\\s", "g"), 
                l.match(i) && (h = l.match(i), h && a.each(h, function(a, b) {
                    ...
                    e && ((d || !j.widgetInit[e.id]) && (j.widgetInit[e.id] = !0, e.hasOwnProperty("options") && (k = b.config.widgetOptions = a.extend(!0, {}, e.options, k)), 
                    e.hasOwnProperty("init") && (j.debug && (g = new Date()), e.init(b, e, j, k), j.debug && u.benchmark("Initializing " + e.id + " widget", g))), 
                    !d && e.hasOwnProperty("format") && (j.debug && (g = new Date()), e.format(b, j, k, !1), 
                    j.debug && u.benchmark((d ? "Initializing " : "Applying ") + e.id + " widget", g)));
                ...
                var f, g, h, i = c.config, j = d.length;
                for (f = 0; j > f; f++) g = u.getWidgetById(d[f]), h = a.inArray(d[f], i.widgets), 
                g && "remove" in g && (i.debug && h >= 0 && b('Removing "' + d[f] + '" widget'), 
                g.remove(c, i, i.widgetOptions, e), i.widgetInit[d[f]] = !1), h >= 0 && e !== !0 && i.widgets.splice(h, 1);
            }, u.refreshWidgets = function(b, c, d) {
                b = a(b)[0];
                var e = b.config, f = e.widgets, g = [], h = function(b) {
                    a(b).trigger("refreshComplete");
                };
                a.each(u.widgets, function(b, d) {
                    d && d.id && (c || a.inArray(d.id, f) < 0) && g.push(d.id);
                }), u.removeWidget(b, g.join(","), !0), d !== !0 ? (u.applyWidget(b, c || !1, h), 
                c && u.applyWidget(b, !1, h)) : h(b);
                ...
                /^\s*\([.\d]+\)/.test(b) && (b = b.replace(/^\s*\(([.\d]+)\)/, "-$1")), d = parseFloat(b), 
                isNaN(d) ? a.trim(b) : d;
    ...
    return a.fn.extend({
        ...
        format: function(a, c, d, e) {
            if (a) {
                ...
                return g = a.replace(/\s+/g, " ").replace(/[\-.,]/g, "/"), "mmddyyyy" === j ? g = g.replace(/(\d{1,2})[\/\s](\d{1,2})[\/\s](\d{4})/, "$3/$1/$2") : "ddmmyyyy" === j ? g = g.replace(/(\d{1,2})[\/\s](\d{1,2})[\/\s](\d{4})/, "$3/$2/$1") : "yyyymmdd" === j && (g = g.replace(/(\d{4})[\/\s](\d{1,2})[\/\s](\d{1,2})/, "$1/$2/$3")), 
                f = new Date(g), f instanceof Date && isFinite(f) ? f.getTime() : a;
            }
            return a;
        },
        type: "numeric"
        ...
        format: function(b, c, d) {
            ...
            for (c.debug && (j = new Date()), k = 0; k < m.length; k++) h = 0, e = m.eq(k), 
            f = e.children("tr:visible").not(c.selectorRemove), f.each(function() {
    ...
    "use strict";
    var d = a.tablesorter = a.tablesorter || {};
    d.storage = function(d, e, f, g) {
        d = a(d)[0];
        var h, i, j, k = !1, l = {}, m = d.config, n = a(d), o = g && g.id || n.attr(g && g.group || "data-table-group") || d.id || a(".tablesorter").index(n), p = g && g.url || n.attr(g && g.page || "data-table-page") || m && m.fixedUrl || b.location.pathname;
        if ("localStorage" in b) try {
            b.localStorage.setItem("_tmptest", "temp"), k = !0, b.localStorage.removeItem("_tmptest");
        } catch (q) {}
        return a.parseJSON && (k ? l = a.parseJSON(localStorage[e] || "null") || {} : (i = c.cookie.split(/[;\s|=]/), 
        h = a.inArray(e, i) + 1, l = 0 !== h ? a.parseJSON(i[h] || "null") || {} : {})), 
        (f || "" === f) && b.JSON && JSON.hasOwnProperty("stringify") ? (l[p] || (l[p] = {}), 
        l[p][o] = f, void (k ? localStorage[e] = JSON.stringify(l) : (j = new Date(), j.setTime(j.getTime() + 31536e6), 
        c.cookie = e + "=" + JSON.stringify(l).replace(/\"/g, '"') + "; expires=" + j.toGMTString() + "; path=/"))) : l && l[p] ? l[p][o] : "";
    };
}(jQuery, window, document), function(a) {
    "use strict";
    var b = a.tablesorter = a.tablesorter || {};
    b.themes = {
        bootstrap: {
        ...
        format: function(c, d, e) {
            var f, g, h, i, j, k, l, m, n, o, p, q, r = b.themes, s = d.$table.add(d.$extraTables), t = d.$headers.add(d.$extraHeaders), u = d.theme || "jui", v = r[u] || {}, w = a.trim([ v.sortNone, v.sortDesc, v.sortAsc, v.active ].join(" ")), x = a.trim([ v.iconSortNone, v.iconSortDesc, v.iconSortAsc ].join(" "));
            ...
            f = 0; f < d.columns; f++) j = d.$headers.add(d.$extraHeaders).not(".sorter-false").filter('[data-column="' + f + '"]'), 
            ...
            h = v.iconSortDesc), m.addClass(g).find("." + b.css.icon).addClass(h || "")));
            d.debug && b.benchmark("Applying " + u + " theme", i);
        },
        remove: function(a, c, d, e) {
    ...
    a.extend(b.css, {
        ...
        remove: function(c, d, e, f) {
            var g, h, i = d.$table, j = d.$tbodies, k = "addRows updateCell update updateRows updateComplete appendCache filterReset filterEnd search ".split(" ").join(d.namespace + "filter ");
            if (i.removeClass("hasFilters").unbind(k.replace(/\s+/g, " ")).find("." + b.css.filterRow).remove(), 
            !f) {
                for (g = 0; g < j.length; g++) h = b.processTbody(c, j.eq(g), !0), h.children().removeClass(e.filter_filteredRow).show(), 
                b.processTbody(c, h, !1);
        ...
        types: {
            regex: function(a, c) {
                if (b.filter.regex.regex.test(c.iFilter)) {
                    var d, e = b.filter.regex.regex.exec(c.iFilter);
                    try {
                        d = new RegExp(e[1], e[2]).test(c.iExact);
                    } catch (f) {
                        d = !1;
                    }
                    return d;
            ...
            operators: function(c, d) {
                if (/^[<>]=?/.test(d.iFilter)) {
                    var e, f, g = c.table, h = d.index, i = d.parsed[h], j = b.formatFloat(d.iFilter.replace(b.filter.regex.operators, ""), g), k = c.parsers[h], l = j;
                    return (i || "numeric" === k.type) && (f = b.filter.parseFilter(c, a.trim("" + d.iFilter.replace(b.filter.regex.operators, "")), h, i, !0), 
                    j = "number" != typeof f || "" === f || isNaN(f) ? j : f), e = !i && "numeric" !== k.type || isNaN(j) || "undefined" == typeof d.cache ? isNaN(d.iExact) ? b.formatFloat(d.iExact.replace(b.filter.regex.nondigit, ""), g) : b.formatFloat(d.iExact, g) : d.cache, 
                    />/.test(d.iFilter) && (f = />=/.test(d.iFilter) ? e >= j : e > j), /</.test(d.iFilter) && (f = /<=/.test(d.iFilter) ? j >= e : j > e), 
                    f || "" !== l || (f = !0), f;
                }
                return null;
            },
            notMatch: function(c, d) {
                if (/^\!/.test(d.iFilter)) {
                    var e, f = b.filter.parseFilter(c, d.iFilter.replace("!", ""), d.index, d.parsed[d.index]);
                    return b.filter.regex.exact.test(f) ? (f = f.replace(b.filter.regex.exact, ""), 
                    "" === f ? !0 : a.trim(f) !== d.iExact) : (e = d.iExact.search(a.trim(f)), "" === f ? !0 : !(c.widgetOptions.filter_startsWith ? 0 === e : e >= 0));
                }
                return null;
            },
            exact: function(c, d) {
                if (b.filter.regex.exact.test(d.iFilter)) {
                    var e = b.filter.parseFilter(c, d.iFilter.replace(b.filter.regex.exact, ""), d.index, d.parsed[d.index]);
            ...
            and: function(c, d) {
                if (b.filter.regex.andTest.test(d.filter)) {
                    for (var e = d.index, f = d.parsed[e], g = d.iFilter.split(b.filter.regex.andSplit), h = d.iExact.search(a.trim(b.filter.parseFilter(c, g[0], e, f))) >= 0, i = g.length - 1; h && i; ) h = h && d.iExact.search(a.trim(b.filter.parseFilter(c, g[i], e, f))) >= 0, 
                    i--;
                    return h;
                }
                return null;
            ...
            range: function(a, c) {
                if (b.filter.regex.toTest.test(c.iFilter)) {
                    var d, e, f = a.table, g = c.index, h = c.parsed[g], i = c.iFilter.split(b.filter.regex.toSplit), j = b.formatFloat(b.filter.parseFilter(a, i[0].replace(b.filter.regex.nondigit, ""), g, h), f), k = b.formatFloat(b.filter.parseFilter(a, i[1].replace(b.filter.regex.nondigit, ""), g, h), f);
                    return (h || "numeric" === a.parsers[g].type) && (d = a.parsers[g].format("" + i[0], f, a.$headers.eq(g), g), 
                    j = "" === d || isNaN(d) ? j : d, d = a.parsers[g].format("" + i[1], f, a.$headers.eq(g), g), 
                    k = "" === d || isNaN(d) ? k : d), d = !h && "numeric" !== a.parsers[g].type || isNaN(j) || isNaN(k) ? isNaN(c.iExact) ? b.formatFloat(c.iExact.replace(b.filter.regex.nondigit, ""), f) : b.formatFloat(c.iExact, f) : c.cache, 
                    j > k && (e = j, j = k, k = e), d >= j && k >= d || "" === j || "" === k;
                }
                return null;
            },
            wild: function(c, d) {
                if (/[\?\*\|]/.test(d.iFilter) || b.filter.regex.orReplace.test(d.filter)) {
                    var e = d.index, f = d.parsed[e], g = b.filter.parseFilter(c, d.iFilter.replace(b.filter.regex.orReplace, "|"), e, f);
                    return !c.$headers.filter('[data-column="' + e + '"]:last').hasClass("filter-match") && /\|/.test(g) && ("|" === g[g.length - 1] && (g += "*"), 
                    g = d.anyMatch && a.isArray(d.rowArray) ? "(" + g + ")" : "^(" + g + ")$"), new RegExp(g.replace(/\?/g, "\\S{1}").replace(/\*/g, "\\S*")).test(d.iExact);
                }
                return null;
            },
            fuzzy: function(a, c) {
                if (/^~/.test(c.iFilter)) {
                    var d, e = 0, f = c.iExact.length, g = b.filter.parseFilter(a, c.iFilter.slice(1), c.index, c.parsed[c.index]);
                    for (d = 0; f > d; d++) c.iExact[d] === g[e] && (e += 1);
        ...
        init: function(c, d, e) {
            b.language = a.extend(!0, {}, {
                to: "to",
                or: "or",
                and: "and"
            }, b.language);
            var f, g, h, i, j, k, l, m, n, o = b.filter.regex;
            if (d.$table.addClass("hasFilters"), e.searchTimer = null, e.filter_initTimer = null, 
            e.filter_formatterCount = 0, e.filter_formatterInit = [], e.filter_anyColumnSelector = '[data-column="all"],[data-column="any"]', 
            e.filter_multipleColumnSelector = '[data-column*="-"],[data-column*=","]', h = "\\{" + b.filter.regex.query + "\\}", 
            a.extend(o, {
                child: new RegExp(d.cssChildRow),
                filtered: new RegExp(e.filter_filteredRow),
                alreadyFiltered: new RegExp("(\\s+(" + b.language.or + "|-|" + b.language.to + ")\\s+)", "i"),
                toTest: new RegExp("\\s+(-|" + b.language.to + ")\\s+", "i"),
                toSplit: new RegExp("(?:\\s+(?:-|" + b.language.to + ")\\s+)", "gi"),
                andTest: new RegExp("\\s+(" + b.language.and + "|&&)\\s+", "i"),
                andSplit: new RegExp("(?:\\s+(?:" + b.language.and + "|&&)\\s+)", "gi"),
                orReplace: new RegExp("\\s+(" + b.language.or + ")\\s+", "gi"),
                iQuery: new RegExp(h, "i"),
                igQuery: new RegExp(h, "ig")
            }), e.filter_columnFilters !== !1 && d.$headers.filter(".filter-false, .parser-false").length !== d.$headers.length && b.filter.buildRow(c, d, e), 
            h = "addRows updateCell update updateRows updateComplete appendCache filterReset filterEnd search ".split(" ").join(d.namespace + "filter "), 
            d.$table.bind(h, function(f, g) {
                return l = e.filter_hideEmpty && a.isEmptyObject(d.cache) && !(d.delayInit && "appendCache" === f.type), 
                d.$table.find("." + b.css.filterRow).toggleClass(e.filter_filteredRow, l), /(search|filter)/.test(f.type) || (f.stopPropagation(), 
                b.filter.buildDefault(c, !0)), "filterReset" === f.type ? (d.$table.find("." + b.css.filter).add(e.filter_$externalFilters).val(""), 
                b.filter.searching(c, [])) : "filterEnd" === f.type ? b.filter.buildDefault(c, !0) : (g = "search" === f.type ? g : "updateComplete" === f.type ? d.$table.data("lastSearch") : "", 
                /(update|add)/.test(f.type) && "updateComplete" !== f.type && (d.lastCombinedFilter = null, 
                d.lastSearch = []), b.filter.searching(c, g, !0)), !1;
                ...
                d.$table.trigger("filterReset");
            })), e.filter_functions) for (j = 0; j < d.columns; j++) if (m = b.getColumnData(c, e.filter_functions, j)) if (i = d.$headers.filter('[data-column="' + j + '"]:last').removeClass("filter-select"), 
            n = !(i.hasClass("filter-false") || i.hasClass("parser-false")), f = "", m === !0 && n) b.filter.buildSelect(c, j); else if ("object" == typeof m && n) {
                for (g in m) "string" == typeof g && (f += "" === f ? '<option value="">' + (i.data("placeholder") || i.attr("data-placeholder") || e.filter_placeholder.select || "") + "</option>" : "", 
                l = g, h = g, g.indexOf(e.filter_selectSourceSeparator) >= 0 && (l = g.split(e.filter_selectSourceSeparator), 
                h = l[1], l = l[0]), f += "<option " + (h === l ? "" : 'data-function-name="' + g + '" ') + 'value="' + l + '">' + h + "</option>");
                d.$table.find("thead").find("select." + b.css.filter + '[data-column="' + j + '"]').append(f);
            }
            b.filter.buildDefault(c, !0), b.filter.bindSearch(c, d.$table.find("." + b.css.filter), !0), 
            e.filter_external && b.filter.bindSearch(c, e.filter_external), e.filter_hideFilters && b.filter.hideFilters(c, d), 
            d.showProcessing && d.$table.unbind("filterStart filterEnd ".split(" ").join(d.namespace + "filter ").replace(/\s+/g, " ")).bind("filterStart filterEnd ".split(" ").join(d.namespace + "filter "), function(e, f) {
                i = f ? d.$table.find("." + b.css.header).filter("[data-column]").filter(function() {
                    return "" !== f[a(this).data("column")];
                }) : "", b.isProcessing(c, "filterStart" === e.type, f ? i : "");
            }), d.filteredRows = d.totalRows, d.$table.unbind("tablesorter-initialized pagerBeforeInitialized ".split(" ").join(d.namespace + "filter ").replace(/\s+/g, " ")).bind("tablesorter-initialized pagerBeforeInitialized ".split(" ").join(d.namespace + "filter "), function() {
                var a = this.config.widgetOptions;
                k = b.filter.setDefaults(c, d, a) || [], k.length && (d.delayInit && "" === k.join("") || b.setFilters(c, k, !0)), 
                d.$table.trigger("filterFomatterUpdate"), setTimeout(function() {
                    a.filter_initialized || b.filter.filterInitComplete(d);
                }, 100);
            }), d.pager && d.pager.initialized && !e.filter_initialized && (d.$table.trigger("filterFomatterUpdate"), 
            setTimeout(function() {
                b.filter.filterInitComplete(d);
            }, 100));
        },
        ...
        filterInitComplete: function(c) {
            var d = c.widgetOptions, e = 0, f = function() {
                d.filter_initialized = !0, c.$table.trigger("filterInit", c), b.filter.findRows(c.table, c.$table.data("lastSearch") || []);
            };
        ...
        setDefaults: function(c, d, e) {
            var f, g, h, i = b.getFilters(c) || [];
            if (e.filter_saveFilters && b.storage && (g = b.storage(c, "tablesorter-filters") || [], 
            f = a.isArray(g), f && "" === g.join("") || !f || (i = g)), "" === i.join("")) for (h = 0; h < d.columns; h++) i[h] = d.$headers.filter('[data-column="' + h + '"]:last').attr(e.filter_defaultAttrib) || i[h];
            return d.$table.data("lastSearch", i), i;
        },
        parseFilter: function(a, b, c, d, e) {
            return e || d ? a.parsers[c].format(b, a.table, [], c) : b;
        },
        buildRow: function(c, d, e) {
            var f, g, h, i, j, k, l, m = d.columns, n = a.isArray(e.filter_cellFilter), o = '<tr role="row" class="' + b.css.filterRow + '">';
            ...
            for (d.$filters = a(o += "</tr>").appendTo(d.$table.children("thead").eq(0)).find("td"), 
            g = 0; m > g; g++) j = !1, h = d.$headers.filter('[data-column="' + g + '"]:last'), 
            l = b.getColumnData(c, e.filter_functions, g), i = e.filter_functions && l && "function" != typeof l || h.hasClass("filter-select"), 
            f = b.getColumnData(c, d.headers, g), j = "false" === b.getData(h[0], f, "filter") || "false" === b.getData(h[0], f, "parser"), 
            i ? o = a("<select>").appendTo(d.$filters.eq(g)) : (l = b.getColumnData(c, e.filter_formatter, g), 
            l ? (e.filter_formatterCount++, o = l(d.$filters.eq(g), g), o && 0 === o.length && (o = d.$filters.eq(g).children("input")), 
            o && (0 === o.parent().length || o.parent().length && o.parent()[0] !== d.$filters[g]) && d.$filters.eq(g).append(o)) : o = a('<input type="search">').appendTo(d.$filters.eq(g)), 
            o && o.attr("placeholder", h.data("placeholder") || h.attr("data-placeholder") || e.filter_placeholder.search || "")), 
            o && (k = (a.isArray(e.filter_cssFilter) ? "undefined" != typeof e.filter_cssFilter[g] ? e.filter_cssFilter[g] || "" : "" : e.filter_cssFilter) || "", 
            o.addClass(b.css.filter + " " + k).attr("data-column", g), j && (o.attr("placeholder", "").addClass("disabled")[0].disabled = !0));
        },
        bindSearch: function(c, d, e) {
            if (c = a(c)[0], d = a(d), d.length) {
                var f = c.config, g = f.widgetOptions, h = g.filter_$externalFilters;
                e !== !0 && (g.filter_$anyMatch = d.filter(g.filter_anyColumnSelector + "," + g.filter_multipleColumnSelector), 
                g.filter_$externalFilters = h && h.length ? g.filter_$externalFilters.add(d) : d, 
                b.setFilters(c, f.$table.data("lastSearch") || [], e === !1)), d.attr("data-lastSearchTime", new Date().getTime()).unbind("keypress keyup search change ".split(" ").join(f.namespace + "filter ").replace(/\s+/g, " ")).bind("keyup" + f.namespace + "filter", function(d) {
                    ...
                    (13 === d.which || "search" === d.type || "change" === d.type && this.value !== f.lastSearch[e]) && (d.preventDefault(), 
                    a(this).attr("data-lastSearchTime", new Date().getTime()), b.filter.searching(c, !1, !0));
                });
            }
        },
        searching: function(a, c, d) {
            var e = a.config.widgetOptions;
            clearTimeout(e.searchTimer), "undefined" == typeof c || c === !0 ? e.searchTimer = setTimeout(function() {
                b.filter.checkFilters(a, c, d);
            }, e.filter_liveSearch ? e.filter_searchDelay : 10) : b.filter.checkFilters(a, c, d);
        },
        checkFilters: function(c, d, e) {
            var f = c.config, g = f.widgetOptions, h = a.isArray(d), i = h ? d : b.getFilters(c, !0), j = (i || []).join("");
            return a.isEmptyObject(f.cache) ? void (f.delayInit && f.pager && f.pager.initialized && f.$table.trigger("updateCache", [ function() {
                b.filter.checkFilters(c, !1, e);
            } ])) : (h && (b.setFilters(c, i, !1, e !== !0), g.filter_initialized || (f.lastCombinedFilter = "")), 
            g.filter_hideFilters && f.$table.find("." + b.css.filterRow).trigger("" === j ? "mouseleave" : "mouseenter"), 
            f.lastCombinedFilter !== j || d === !1 ? (d === !1 && (f.lastCombinedFilter = null, 
            f.lastSearch = []), g.filter_initialized && f.$table.trigger("filterStart", [ i ]), 
            f.showProcessing ? void setTimeout(function() {
                return b.filter.findRows(c, i, j), !1;
            }, 30) : (b.filter.findRows(c, i, j), !1)) : void 0);
        },
        hideFilters: function(c, d) {
            var e, f, g;
            a(c).find("." + b.css.filterRow).addClass("hideme").bind("mouseenter mouseleave", function(b) {
                var c = b;
                ...
                g = setTimeout(function() {
                    "" === b.getFilters(d.$table).join("") && f["focus" === e.type ? "removeClass" : "addClass"]("hideme");
                }, 200);
            });
        },
        ...
        multipleColumns: function(c, d) {
            var e, f, g, h = c.widgetOptions, i = h.filter_initialized || !d.filter(h.filter_anyColumnSelector).length, j = [], k = a.trim(b.filter.getLatestSearch(d).attr("data-column") || "");
            if (i && /-/.test(k) && (e = k.match(/(\d+)\s*-\s*(\d+)/g), a.each(e, function(a, b) {
                var d, e = b.split(/\s*-\s*/), f = parseInt(e[0], 10) || 0, g = parseInt(e[1], 10) || c.columns - 1;
                for (f > g && (d = f, f = g, g = d), g >= c.columns && (g = c.columns - 1); g >= f; f++) j.push(f);
                k = k.replace(b, "");
            })), i && /,/.test(k) && (f = k.split(/\s*,\s*/), a.each(f, function(a, b) {
                "" !== b && (g = parseInt(b, 10), g < c.columns && j.push(g));
            })), !j.length) for (g = 0; g < c.columns; g++) j.push(g);
            return j;
        },
        findRows: function(c, d, e) {
            if (c.config.lastCombinedFilter !== e && c.config.widgetOptions.filter_initialized) {
                var f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w, x, y, z, A, B, C, D, E, F, G, H = b.filter.regex, I = c.config, J = I.widgetOptions, K = {
                    anyMatch: !1
                }, L = [ "range", "notMatch", "operators" ];
                for (K.parsed = I.$headers.map(function(d) {
                    return I.parsers && I.parsers[d] && I.parsers[d].parsed || b.getData && "parsed" === b.getData(I.$headers.filter('[data-column="' + d + '"]:last'), b.getColumnData(c, I.headers, d), "filter") || a(this).hasClass("filter-parsed");
                }).get(), I.debug && (b.log("Starting filter widget search", d), u = new Date()), 
                I.filteredRows = 0, I.totalRows = 0, e = (d || []).join(""), j = 0; j < I.$tbodies.length; j++) {
                    ...
                    h = a(a.map(g, function(a) {
                        return a[n].$row.get();
                    })), "" === e || J.filter_serversideFiltering) h.removeClass(J.filter_filteredRow).not("." + I.cssChildRow).show(); else {
                        if (h = h.not("." + I.cssChildRow), f = h.length, (J.filter_$anyMatch && J.filter_$anyMatch.length || "undefined" != typeof d[I.columns]) && (K.anyMatchFlag = !0, 
                        K.anyMatchFilter = J.filter_$anyMatch && b.filter.getLatestSearch(J.filter_$anyMatch).val() || "" + d[I.columns] || "", 
                        J.filter_columnAnyMatch)) {
                            for (D = K.anyMatchFilter.split(b.filter.regex.andSplit), E = !1, w = 0; w < D.length; w++) F = D[w].split(":"), 
                            F.length > 1 && (G = parseInt(F[0], 10) - 1, G >= 0 && G < I.columns && (d[G] = F[1], 
                            D.splice(w, 1), w--, E = !0));
                            E && (K.anyMatchFilter = D.join(" && "));
                        }
                        if (y = J.filter_searchFiltered, p = I.lastSearch || I.$table.data("lastSearch") || [], 
                        y) for (w = 0; n + 1 > w; w++) v = d[w] || "", y || (w = n), y = !(!y || !p.length || 0 !== v.indexOf(p[w] || "") || H.alreadyFiltered.test(v) || /[=\"\|!]/.test(v) || /(>=?\s*-\d)/.test(v) || /(<=?\s*\d)/.test(v) || "" !== v && I.$filters && I.$filters.eq(w).find("select").length && !I.$headers.filter('[data-column="' + w + '"]:last').hasClass("filter-match"));
                        for (x = h.not("." + J.filter_filteredRow).length, y && 0 === x && (y = !1), I.debug && b.log("Searching through " + (y && f > x ? x : "all") + " rows"), 
                        ...
                        i = 0; f > i; i++) if (K.cacheArray = g[i], o = h[i].className, !(H.child.test(o) || y && H.filtered.test(o))) {
                            ...
                            K.childRowText = J.filter_ignoreCase ? K.childRowText.toLocaleLowerCase() : K.childRowText, 
                            l = h.eq(i).children(), K.anyMatchFlag) {
                                if (n = b.filter.multipleColumns(I, J.filter_$anyMatch), K.anyMatch = !0, K.rowArray = l.map(function(c) {
                                    if (a.inArray(c, n) > -1) {
                                        var d;
                                        return K.parsed[c] ? d = K.cacheArray[c] : (d = this ? this.getAttribute(I.textAttribute) || this.textContent || a(this).text() : "", 
                                        d = a.trim(J.filter_ignoreCase ? d.toLowerCase() : d), I.sortLocaleCompare && (d = b.replaceAccents(d))), 
                                        d;
                                    }
                                }).get(), K.filter = K.anyMatchFilter, K.iFilter = K.iAnyMatchFilter, K.exact = K.rowArray.join(" "), 
                                K.iExact = J.filter_ignoreCase ? K.exact.toLowerCase() : K.exact, K.cache = K.cacheArray.slice(0, -1).join(" "), 
                                z = null, a.each(b.filter.types, function(b, c) {
                                    return a.inArray(b, L) < 0 && (r = c(I, K), null !== r) ? (z = r, !1) : void 0;
                                }), null !== z) t = z; else if (J.filter_startsWith) for (t = !1, n = I.columns; !t && n > 0; ) n--, 
                            ...
                            B = b.getColumnData(c, J.filter_functions, n), m = I.$headers.filter('[data-column="' + n + '"]:last'), 
                            q = m.hasClass("filter-select"), B || q && v ? B === !0 || q ? s = m.hasClass("filter-match") ? K.iExact.search(K.iFilter) >= 0 : K.filter === K.exact : "function" == typeof B ? s = B(K.exact, K.cache, K.filter, n, h.eq(i)) : "function" == typeof B[C || K.filter] && (s = B[C || K.filter](K.exact, K.cache, K.filter, n, h.eq(i))) : (z = null, 
                            ...
                            t = s ? t : !1);
                            h.eq(i).toggle(t).toggleClass(J.filter_filteredRow, !t), o.length && o.toggleClass(J.filter_filteredRow, !t);
                        }
                    }
                    I.filteredRows += h.not("." + J.filter_filteredRow).length, I.totalRows += h.length, 
                    b.processTbody(c, k, !1);
                }
                I.lastCombinedFilter = e, I.lastSearch = d, I.$table.data("lastSearch", d), J.filter_saveFilters && b.storage && b.storage(c, "tablesorter-filters", d), 
                I.debug && b.benchmark("Completed filter widget search", u), J.filter_initialized && I.$table.trigger("filterEnd", I), 
                setTimeout(function() {
                    I.$table.trigger("applyWidgets");
                }, 0);
            }
        },
        getOptionSource: function(c, d, e) {
            c = a(c)[0];
            var f, g = c.config, h = g.widgetOptions, i = [], j = !1, k = h.filter_selectSource, l = g.$table.data("lastSearch") || [], m = a.isFunction(k) ? !0 : b.getColumnData(c, k, d);
            if (e && "" !== l[d] && (e = !1), m === !0) j = k(c, d, e); else {
                if (m instanceof a || "string" === a.type(m) && m.indexOf("</option>") >= 0) return m;
                a.isArray(m) ? j = m : "object" === a.type(k) && m && (j = m(c, d, e));
            }
            return j === !1 && (j = b.filter.getOptions(c, d, e)), j = a.grep(j, function(b, c) {
                return a.inArray(b, j) === c;
            }), g.$headers.filter('[data-column="' + d + '"]:last').hasClass("filter-select-nosort") ? j : (a.each(j, function(a, b) {
                i.push({
                    t: b,
                    p: g.parsers && g.parsers[d].format(b, c, [], d)
                });
        ...
        getOptions: function(b, c, d) {
            b = a(b)[0];
            var e, f, g, h, i, j, k = b.config, l = k.widgetOptions, m = [];
            for (f = 0; f < k.$tbodies.length; f++) for (i = k.cache[f], g = k.cache[f].normalized.length, 
            e = 0; g > e; e++) h = i.row ? i.row[e] : i.normalized[e][k.columns].$row[0], d && h.className.match(l.filter_filteredRow) || (l.filter_useParsedData || k.parsers[c].parsed || k.$headers.filter('[data-column="' + c + '"]:last').hasClass("filter-parsed") ? m.push("" + i.normalized[e][c]) : (j = h.cells[c], 
            j && m.push(a.trim(j.getAttribute(k.textAttribute) || j.textContent || a(j).text()))));
            return m;
        },
        buildSelect: function(c, d, e, f, g) {
            if (c = a(c)[0], d = parseInt(d, 10), c.config.cache && !a.isEmptyObject(c.config.cache)) {
                var h, i, j, k, l, m, n = c.config, o = n.widgetOptions, p = n.$headers.filter('[data-column="' + d + '"]:last'), q = '<option value="">' + (p.data("placeholder") || p.attr("data-placeholder") || o.filter_placeholder.select || "") + "</option>", r = n.$table.find("thead").find("select." + b.css.filter + '[data-column="' + d + '"]').val();
                if (("undefined" == typeof e || "" === e) && (e = b.filter.getOptionSource(c, d, g)), 
                a.isArray(e)) {
                    for (h = 0; h < e.length; h++) j = e[h] = ("" + e[h]).replace(/\"/g, "&quot;"), 
                    i = j, j.indexOf(o.filter_selectSourceSeparator) >= 0 && (k = j.split(o.filter_selectSourceSeparator), 
                    i = k[0], j = k[1]), q += "" !== e[h] ? "<option " + (i === j ? "" : 'data-function-name="' + e[h] + '" ') + 'value="' + i + '">' + j + "</option>" : "";
                    e = [];
                }
                l = (n.$filters ? n.$filters : n.$table.children("thead")).find("." + b.css.filter), 
                o.filter_$externalFilters && (l = l && l.length ? l.add(o.filter_$externalFilters) : o.filter_$externalFilters), 
                m = l.filter('select[data-column="' + d + '"]'), m.length && (m[f ? "html" : "append"](q), 
                a.isArray(e) || m.append(e).val(r), m.val(r));
            }
        },
        buildDefault: function(a, c) {
            ...
            f = !(e.hasClass("filter-false") || e.hasClass("parser-false")), (e.hasClass("filter-select") || b.getColumnData(a, h.filter_functions, d) === !0) && f && b.filter.buildSelect(a, d, "", c, e.hasClass(h.filter_onlyAvail));
        }
    }, b.getFilters = function(c, d, e, f) {
        var g, h, i, j, k = !1, l = c ? a(c)[0].config : "", m = l ? l.widgetOptions : "";
        if (d !== !0 && m && !m.filter_columnFilters) return a(c).data("lastSearch");
        if (l && (l.$filters && (h = l.$filters.find("." + b.css.filter)), m.filter_$externalFilters && (h = h && h.length ? h.add(m.filter_$externalFilters) : m.filter_$externalFilters), 
        h && h.length)) for (k = e || [], g = 0; g < l.columns + 1; g++) j = g === l.columns ? m.filter_anyColumnSelector + "," + m.filter_multipleColumnSelector : '[data-column="' + g + '"]', 
        i = h.filter(j), i.length && (i = b.filter.getLatestSearch(i), a.isArray(e) ? (f && i.slice(1), 
        g === l.columns && (j = i.filter(m.filter_anyColumnSelector), i = j.length ? j : i), 
        i.val(e[g]).trigger("change.tsfilter")) : (k[g] = i.val() || "", g === l.columns ? i.slice(1).filter('[data-column*="' + i.attr("data-column") + '"]').val(k[g]) : i.slice(1).val(k[g])), 
        ...
        return g && e && (g.lastCombinedFilter = null, g.lastSearch = [], b.filter.searching(g.table, d, f), 
        g.$table.trigger("filterFomatterUpdate")), !!h;
    };
}(jQuery), function(a, b) {
    "use strict";
    ...
    a.extend(c.css, {
        ...
        var e, f = {
            timer: 250
        }, g = a.extend({}, f, d), h = b.config, i = h.widgetOptions, j = function(b) {
            i.resize_flag = !0, e = [], h.$headers.each(function() {
                var b = a(this), c = b.data("savedSizes") || [ 0, 0 ], d = this.offsetWidth, f = this.offsetHeight;
        ...
        format: function(d, e, f) {
            if (!(e.$table.hasClass("hasStickyHeaders") || a.inArray("filter", e.widgets) >= 0 && !e.$table.hasClass("hasFilters"))) {
                var g, h = e.$table, i = a(f.stickyHeaders_attachTo), j = e.namespace + "stickyheaders ", k = a(f.stickyHeaders_yScroll || f.stickyHeaders_attachTo || b), l = a(f.stickyHeaders_xScroll || f.stickyHeaders_attachTo || b), m = h.children("thead:first"), n = m.children("tr").not(".sticky-false").children(), o = h.children("tfoot"), p = isNaN(f.stickyHeaders_offset) ? a(f.stickyHeaders_offset) : "", q = i.length ? 0 : p.length ? p.height() || 0 : parseInt(f.stickyHeaders_offset, 10) || 0, r = h.parent().closest("." + c.css.table).hasClass("hasStickyHeaders") ? h.parent().closest("table.tablesorter")[0].config.widgetOptions.$sticky.parent() : [], s = r.length ? r.height() : 0, t = f.$sticky = h.clone().addClass("containsStickyHeaders " + c.css.sticky + " " + f.stickyHeaders).wrap('<div class="' + c.css.stickyWrap + '">'), u = t.parent().css({
                ...
                }), v = t.children("thead:first"), w = "", x = 0, y = function(c, d) {
                    c.filter(":visible").each(function(c) {
                        var e, f, g = d.filter(":visible").eq(c), h = a(this);
                        "border-box" === h.css("box-sizing") ? e = h.outerWidth() : "collapse" === g.css("border-collapse") ? b.getComputedStyle ? e = parseFloat(b.getComputedStyle(this, null).width) : (f = parseFloat(h.css("border-width")), 
                    ...
                    q = p.length ? p.height() || 0 : parseInt(f.stickyHeaders_offset, 10) || 0, x = 0, 
                    u.css({
                        left: i.length ? parseInt(i.css("padding-left"), 10) || 0 : h.offset().left - parseInt(h.css("margin-left"), 10) - l.scrollLeft() - x,
                        width: h.outerWidth()
                    }), y(h, t), y(n, g);
                };
                e.$extraTables && e.$extraTables.length ? e.$extraTables.add(t) : e.$extraTables = t, 
                t.attr("id") && (t[0].id += f.stickyHeaders_cloneId), t.find("thead:gt(0), tr.sticky-false").hide(), 
                t.find("tbody, tfoot").remove(), t.find("caption").toggle(f.stickyHeaders_includeCaption), 
                g = v.children().children(), t.css({
                    height: 0,
                    width: 0,
                    margin: 0
                ...
                }), l.add(k).unbind("scroll resize ".split(" ").join(j).replace(/\s+/g, " ")).bind("scroll resize ".split(" ").join(j), function(b) {
                    if (h.is(":visible")) {
                        s = r.length ? r.offset().top - k.scrollTop() + r.height() : 0;
                        var c = "tablesorter-sticky-", d = h.offset(), e = a.isWindow(k[0]), f = a.isWindow(l[0]), g = (i.length ? e ? k.scrollTop() : k.offset().top : k.scrollTop()) + q + s, j = h.height() - (u.height() + (o.height() || 0)), m = g > d.top && g < d.top + j ? "visible" : "hidden", n = {
                            visibility: m
                        };
                        i.length && (n.top = e ? g : i.scrollTop()), f && (n.left = h.offset().left - parseInt(h.css("margin-left"), 10) - l.scrollLeft() - x), 
                        r.length && (n.top = (n.top || 0) + q + s), u.removeClass(c + "visible " + c + "hidden").addClass(c + m).css(n), 
                        (m !== w || "resize" === b.type) && (z(), w = m);
                    }
                    ...
                    u.hasClass(c.css.stickyVis) && f.stickyHeaders_filteredToTop && (b.scrollTo(0, h.position().top), 
                    g >= 0 && e.$filters && e.$filters.eq(g).find("a, select, input").filter(":visible").focus());
                }), c.filter.bindSearch(h, g.find("." + c.css.filter)), f.filter_hideFilters && c.filter.hideFilters(t, e)), 
                h.trigger("stickyHeadersInit");
            }
        },
        remove: function(d, e, f) {
            var g = e.namespace + "stickyheaders ";
            e.$table.removeClass("hasStickyHeaders").unbind("pagerComplete filterEnd ".split(" ").join(g).replace(/\s+/g, " ")).next("." + c.css.stickyWrap).remove(), 
    ...
    a.extend(c.css, {
        ...
        format: function(d, e, f) {
            if (!e.$table.hasClass("hasResizable")) {
                ...
                var g, h, i, j, k, l = {}, m = e.$table, n = m.parent(), o = "auto" === m.parent().css("overflow"), p = 0, q = null, r = null, s = Math.abs(m.parent().width() - m.width()) < 20, t = function(a) {
                    if (0 !== p && q) {
                        var b = a.pageX - p, c = q.width();
                        q.width(c + b), q.width() !== c && s ? r.width(r.width() - b) : o && (m.width(function(a, c) {
                            return c + b;
                        }), r.length || (n[0].scrollLeft = m.width())), p = a.pageX;
                    }
                }, u = function() {
                    c.storage && q && r && (l = {}, l[q.index()] = q.width(), l[r.index()] = r.width(), 
                    q.width(l[q.index()]), r.width(l[r.index()]), f.resizable !== !1 && c.storage(d, "tablesorter-resizable", e.$headers.map(function() {
                        return a(this).width();
                ...
                g = m.children("thead:first").children("tr"), g.children().each(function() {
                    var b, f = a(this);
                    j = f.attr("data-column"), b = "false" === c.getData(f, c.getColumnData(d, e.headers, j), "resizable"), 
                    g.children().filter('[data-column="' + j + '"]')[b ? "addClass" : "removeClass"]("resizable-false");
                }), g.each(function() {
                    i = a(this).children().not(".resizable-false"), a(this).find("." + c.css.wrapper).length || i.wrapInner('<div class="' + c.css.wrapper + '" style="position:relative;height:100%;width:100%"></div>'), 
                    f.resizable_addLastColumn || (i = i.slice(0, -1)), h = h ? h.add(i) : i;
                }), h.each(function() {
                    var b = a(this), d = parseInt(b.css("padding-right"), 10) + 10;
                    ...
                    c.length > 1 && (q = q.add(c)), r = b.shiftKey ? q.parent().find("th").not(".resizable-false").filter(":last") : q.nextAll(":not(.resizable-false)").eq(0), 
                    p = b.pageX;
        ...
        remove: function(a, b) {
            b.$table.removeClass("hasResizable").children("thead").unbind("mouseup.tsresize mouseleave.tsresize contextmenu.tsresize").children("tr").children().unbind("mousemove.tsresize mouseup.tsresize").find("." + c.css.resizer).remove(), 
            c.resizableReset(a);
        }
    }), c.resizableReset = function(b, d) {
        a(b).each(function() {
            var e, f = this.config, g = f && f.widgetOptions;
            b && f && (f.$headers.each(function(b) {
                e = a(this), g.resizable_widths && g.resizable_widths[b] ? e.css("width", g.resizable_widths[b]) : e.hasClass("resizable-false") || e.css("width", "");
    ...
    b.addWidget({
        ...
        format: function(c, d, e, f) {
            ...
            d.debug && b.benchmark("saveSort widget: Saving last sort: " + d.sortList, h)) : (i.addClass("hasSaveSort"), 
            k = "", b.storage && (g = b.storage(c, "tablesorter-savesort"), k = g && g.hasOwnProperty("sortList") && a.isArray(g.sortList) ? g.sortList : "", 
            d.debug && b.benchmark('saveSort: Last sort loaded: "' + k + '"', h), i.bind("saveSortReset", function(a) {
