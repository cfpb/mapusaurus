!function(a, b) {
    ...
    a.extend({
        tablesorter: new function() {
            ...
            var u = this;
            u.version = "2.21.2", u.parsers = [], u.widgets = [], u.defaults = {
                theme: "default",
                widthFixed: !1,
                showProcessing: !1,
        ...
        a.extend(b.css, {
            ...
            init: function(c, d, e) {
                ...
                d.$table.bind(h, function(f, g) {
                    ...
                    d.$table.trigger("filterReset");
                })), e.filter_functions) for (j = 0; j < d.columns; j++) if (m = b.getColumnData(c, e.filter_functions, j)) if (i = d.$headerIndexed[j].removeClass("filter-select"), 
            ...
            buildRow: function(c, d, e) {
                ...
                g = 0; m > g; g++) j = !1, h = d.$headerIndexed[g], l = b.getColumnData(c, e.filter_functions, g), 
                i = e.filter_functions && l && "function" != typeof l || h.hasClass("filter-select"), 
            ...
            buildSelect: function(c, d, e, f, g) {
                if (c = a(c)[0], d = parseInt(d, 10), c.config.cache && !a.isEmptyObject(c.config.cache)) {
                    var h, i, j, k, l, m, n = c.config, o = n.widgetOptions, p = n.$headerIndexed[d], q = '<option value="">' + (p.data("placeholder") || p.attr("data-placeholder") || o.filter_placeholder.select || "") + "</option>", r = n.$table.find("thead").find("select." + b.css.filter + '[data-column="' + d + '"]').val();
        ...
        a.extend(c.css, {
            ...
            format: function(d, e, f) {
                if (!(e.$table.hasClass("hasStickyHeaders") || a.inArray("filter", e.widgets) >= 0 && !e.$table.hasClass("hasFilters"))) {
                    ...
                    i.length && !i.css("position") && i.css("position", "relative"), e.$extraTables && e.$extraTables.length ? e.$extraTables.add(t) : e.$extraTables = t, 
