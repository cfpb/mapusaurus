!function(a, b) {
    ...
    return function(a) {
            ...
            tablesorter: new function() {
                ...
                function f(a) {
                    ...
                    for (o.debug && (n = new Date(), b("Detecting parsers for each column")), f = {
                        ...
                        if (d = p[q].rows, d.length) for (g = o.columns, h = 0; g > h; h++) i = o.$headerIndexed[h], 
                ...
                function j(d) {
                    ...
                    for (o.headerList = [], o.headerContent = [], o.debug && (m = new Date()), o.columns = u.computeColumnIndex(o.$table.children("thead, tfoot").children("tr")), 
                    ...
                    o.$headers = a(a.map(a(d).find(o.selectorHeaders), function(b, c) {
                        return f = a(b), f.parent().hasClass(o.cssIgnoreRow) ? void 0 : (e = u.getColumnData(d, o.headers, c, !0), 
                        o.headerContent[c] = f.html(), "" === o.headerTemplate || f.find("." + u.css.headerIn).length || (j = o.headerTemplate.replace(/\{content\}/g, f.html()).replace(/\{icon\}/g, f.find("." + u.css.icon).length ? "" : h), 
                        o.onRenderTemplate && (g = o.onRenderTemplate.apply(f, [ c, j ]), g && "string" == typeof g && (j = g)), 
                        f.html('<div class="' + u.css.headerIn + '">' + j + "</div>")), o.onRenderHeader && o.onRenderHeader.apply(f, [ c, o, o.$table ]), 
                        b.column = parseInt(f.attr("data-column"), 10), b.order = i(u.getData(f, e, "sortInitialOrder") || o.sortInitialOrder) ? [ 1, 0, 2 ] : [ 0, 1, 2 ], 
                        b.count = -1, b.lockedOrder = !1, k = u.getData(f, e, "lockedOrder") || !1, "undefined" != typeof k && k !== !1 && (b.order = b.lockedOrder = i(k) ? [ 1, 1, 1 ] : [ 0, 0, 0 ]), 
                        f.addClass(u.css.header + " " + o.cssHeader), o.headerList[c] = b, f.parent().addClass(u.css.headerRow + " " + o.cssHeaderRow).attr("role", "row"), 
                        o.tabIndex && f.attr("tabindex", 0), b);
                    })), o.$headerIndexed = [], n = 0; n < o.columns; n++) f = o.$headers.filter('[data-column="' + n + '"]'), 
                    o.$headerIndexed[n] = f.not(".sorter-false").length ? f.not(".sorter-false").filter(":last") : f.filter(":last");
                    a(d).find(o.selectorHeaders).attr({
                        scope: "col",
                        role: "columnheader"
                    }), l(d), o.debug && (c("Built headers:", m), b(o.$headers));
                }
                function k(a, b, c) {
                    var d = a.config;
                ...
                function m(b) {
                    var c, d, e, f = b.config, g = f.sortList, h = g.length, i = u.css.sortNone + " " + f.cssNone, j = [ u.css.sortAsc + " " + f.cssAsc, u.css.sortDesc + " " + f.cssDesc ], k = [ f.cssIconAsc, f.cssIconDesc, f.cssIconNone ], l = [ "ascending", "descending" ], m = a(b).find("tfoot tr").children().add(a(f.namespace + "_extra_headers")).removeClass(j.join(" "));
                    ...
                    c.length)) {
                        for (e = 0; e < c.length; e++) c[e].sortDisabled || c.eq(e).removeClass(i).addClass(j[g[d][1]]).attr("aria-sort", l[g[d][1]]).find("." + u.css.icon).removeClass(k[2]).addClass(k[g[d][1]]);
                ...
                function n(b, c) {
                    ...
                    for (l.sortList = [], h = 0; n > h; h++) if (k = m[h], d = parseInt(k[0], 10), g = l.$headerIndexed[d][0]) {
                        switch (e = ("" + k[1]).match(/^(1|d|s|o|n)/), e = e ? e[0] : "") {
                          case "1":
                          case "d":
                            e = 1;
                            break;
                        ...
                        i = 0 === h ? e : i, f = [ d, parseInt(e, 10) || 0 ], l.sortList.push(f), e = a.inArray(f[1], g.order), 
                ...
                function p(b, c, d) {
                    ...
                    k.sortRestart && (f = c, k.$headers.each(function() {
                        ...
                        i = k.$headerIndexed[j[0]][0], j[0] === f && (j[1] = i.order[c.count], 2 === j[1] && (k.sortList.splice(g, 1), 
                        i.count = -1)); else if (i = c.order[c.count], 2 > i && (k.sortList.push([ f, i ]), 
                        c.colSpan > 1)) for (g = 1; g < c.colSpan; g++) k.sortList.push([ f + g, i ]);
                    }
                ...
                u.version = "2.21.4", u.parsers = [], u.widgets = [], u.defaults = {
                ...
                }, u.instanceMethods = {}, u.log = b, u.benchmark = c, u.getElementText = function(b, c, d) {
                    if (!c) return "";
                    ...
                    return this.each(function() {
                        var c = this, d = a.extend(!0, {}, u.defaults, b, u.instanceMethods);
                        d.originalSettings = b, !c.hasInitialized && u.buildTable && "TABLE" !== this.nodeName ? u.buildTable(c, d) : u.setup(c, d);
                    });
                    ...
                    j(c), u.fixColumnWidth(c), u.applyWidgetOptions(c, d), f(c), d.totalRows = 0, d.delayInit || g(c), 
                    u.bindEvents(c, d.$headers, !0), t(c), d.supportsDataObject && "undefined" != typeof h.data().sortlist ? d.sortList = h.data().sortlist : i && h.metadata() && h.metadata().sortlist && (d.sortList = h.metadata().sortlist), 
                    ...
                    b = a(b)[0];
                    var f, h = null, i = b.config;
                    e !== !0 && (c.addClass(i.namespace.slice(1) + "_extra_headers"), f = a.fn.closest ? c.closest("table")[0] : c.parents("table")[0], 
                    f && "TABLE" === f.nodeName && f !== b && a(f).addClass(i.namespace.slice(1) + "_extra_table")), 
                    c.find(i.selectorSort).add(c.filter(i.selectorSort)).unbind("mousedown mouseup click sort keyup ".split(" ").join(i.namespace + " ").replace(/\s+/g, " ")).bind("mousedown mouseup click sort keyup ".split(" ").join(i.namespace + " "), function(e, f) {
                        var j, k = a(e.target), l = e.type;
                        if (!(1 !== (e.which || e.button) && !/sort|keyup|click/.test(l) || "keyup" === l && 13 !== e.which || "click" === l && "undefined" != typeof e.which || "mouseup" === l && h !== e.target && f !== !0)) {
                            if ("mousedown" === l) return void (h = e.target);
                            if (h = null, /(input|select|button|textarea)/i.test(e.target.nodeName) || k.hasClass(i.cssNoSort) || k.parents("." + i.cssNoSort).length > 0 || k.parents("button").length > 0) return !i.cancelSelection;
                            i.delayInit && d(i.cache) && g(b), j = a.fn.closest ? a(this).closest("th, td")[0] : /TH|TD/.test(this.nodeName) ? this : a(this).parents("th, td")[0], 
                            j = i.$headers[c.index(j)], j.sortDisabled || p(b, j, e);
                        }
                    }), i.cancelSelection && c.attr("unselectable", "on").bind("selectstart", !1).css({
                        "user-select": "none",
                        MozUserSelect: "none"
                    });
                    ...
                    if (f) for (d = 0; f > d; d++) e = u.getWidgetById(c.widgets[d]), e && "options" in e && (g = b.config.widgetOptions = a.extend(!0, {}, e.options, g));
                    ...
                    if (d === !1 || !b.hasInitialized || !b.isApplyingWidgets && !b.isUpdating) {
                        if (m.debug && (i = new Date()), l = new RegExp("\\s" + m.widgetClass.replace(/\{name\}/i, "([\\w-]+)") + "\\s", "g"), 
                        o.match(l) && (k = o.match(l))) for (g = k.length, f = 0; g > f; f++) m.widgets.push(k[f].replace(l, "$1"));
                        if (m.widgets.length) {
                            for (b.isApplyingWidgets = !0, m.widgets = a.grep(m.widgets, function(b, c) {
                                return a.inArray(b, m.widgets) === c;
                            }), h = m.widgets || [], g = h.length, f = 0; g > f; f++) l = u.getWidgetById(h[f]), 
                            l && l.id && (l.priority || (l.priority = 10), p[f] = l);
                            for (p.sort(function(a, b) {
                                return a.priority < b.priority ? -1 : a.priority === b.priority ? 0 : 1;
                            }), g = p.length, f = 0; g > f; f++) p[f] && ((d || !m.widgetInit[p[f].id]) && (m.widgetInit[p[f].id] = !0, 
                            b.hasInitialized && u.applyWidgetOptions(b, m), "init" in p[f] && (m.debug && (j = new Date()), 
                            p[f].init(b, p[f], m, n), m.debug && u.benchmark("Initializing " + p[f].id + " widget", j))), 
                            !d && "format" in p[f] && (m.debug && (j = new Date()), p[f].format(b, m, n, !1), 
                        ...
                        }, 0), m.debug && (k = m.widgets.length, c("Completed " + (d === !0 ? "initializing " : "applying ") + k + " widget" + (1 !== k ? "s" : ""), i));
                    }
                }, u.removeWidget = function(c, d, e) {
                    c = a(c)[0];
                    var f, g, h, i, j = c.config;
                    if (d === !0) for (d = [], i = u.widgets.length, h = 0; i > h; h++) g = u.widgets[h], 
                    g && g.id && d.push(g.id); else d = (a.isArray(d) ? d.join(",") : d || "").toLowerCase().split(/[\s,]+/);
                    for (i = d.length, f = 0; i > f; f++) g = u.getWidgetById(d[f]), h = a.inArray(d[f], j.widgets), 
                    ...
                    u.removeWidget(b, j.join(","), !0), d !== !0 ? (u.applyWidget(b, c || !1, k), c && u.applyWidget(b, !1, k)) : k(b);
                }, u.getColumnText = function(b, c, e) {
                    b = a(b)[0];
                    var f, g, h, i, j, k, l, m, n, o, p = "function" == typeof e, q = "all" === c, r = {
                        raw: [],
                        parsed: [],
                        $cell: []
                    }, s = b.config;
                    if (!d(s)) {
                        for (j = s.$tbodies.length, f = 0; j > f; f++) for (h = s.cache[f].normalized, k = h.length, 
                        g = 0; k > g; g++) o = !0, i = h[g], m = q ? i.slice(0, s.columns) : i[c], i = i[s.columns], 
                        l = q ? i.raw : i.raw[c], n = q ? i.$row.children() : i.$row.children().eq(c), p && (o = e({
                            tbodyIndex: f,
                            rowIndex: g,
                            parsed: m,
                            raw: l,
                            $row: i.$row,
                            $cell: n
                        })), o !== !1 && (r.parsed.push(m), r.raw.push(l), r.$cell.push(n));
                        return r;
                    }
        ...
        a.fn.extend({
            ...
            priority: 90,
            format: function(b, c, d) {
                var e, f, g, h, i, j, k, l = new RegExp(c.cssChildRow, "i"), m = c.$tbodies.add(a(c.namespace + "_extra_table").children("tbody"));
    ...
    return function(a, b, c) {
        ...
        d.storage = function(e, f, g, h) {
            e = a(e)[0];
            var i, j, k, l = !1, m = {}, n = e.config, o = n && n.widgetOptions, p = h && h.useSessionStorage || o && o.storage_useSessionStorage ? "sessionStorage" : "localStorage", q = a(e), r = h && h.id || q.attr(h && h.group || o && o.storage_group || "data-table-group") || o && o.storage_tableId || e.id || a(".tablesorter").index(q), s = h && h.url || q.attr(h && h.page || o && o.storage_page || "data-table-page") || o && o.storage_fixedUrl || n && n.fixedUrl || b.location.pathname;
            if (p in b) try {
                b[p].setItem("_tmptest", "temp"), l = !0, b[p].removeItem("_tmptest");
            } catch (t) {
                n && n.debug && d.log(p + " is not supported in this browser");
            }
            return a.parseJSON && (l ? m = a.parseJSON(b[p][f] || "null") || {} : (j = c.cookie.split(/[;\s|=]/), 
            i = a.inArray(f, j) + 1, m = 0 !== i ? a.parseJSON(j[i] || "null") || {} : {})), 
            (g || "" === g) && b.JSON && JSON.hasOwnProperty("stringify") ? (m[s] || (m[s] = {}), 
            m[s][r] = g, void (l ? b[p][f] = JSON.stringify(m) : (k = new Date(), k.setTime(k.getTime() + 31536e6), 
            c.cookie = f + "=" + JSON.stringify(m).replace(/\"/g, '"') + "; expires=" + k.toGMTString() + "; path=/"))) : m && m[s] ? m[s][r] : "";
        };
        ...
        "use strict";
        var b = a.tablesorter = a.tablesorter || {}, c = b.css;
        a.extend(c, {
            ...
            remove: function(d, e, f, g) {
                ...
                if (j.removeClass("hasFilters").unbind(l.replace(/\s+/g, " ")).find("." + c.filterRow).remove(), 
                !g) {
                    for (h = 0; h < k.length; h++) i = b.processTbody(d, k.eq(h), !0), i.children().removeClass(f.filter_filteredRow).show(), 
                    b.processTbody(d, i, !1);
            ...
            types: {
                ...
                wild: function(c, d) {
                    if (/[\?\*\|]/.test(d.iFilter) || b.filter.regex.orReplace.test(d.filter)) {
                        ...
                        return !c.$headerIndexed[e].hasClass("filter-match") && /\|/.test(g) && ("|" === g[g.length - 1] && (g += "*"), 
            ...
            init: function(d, e, f) {
                ...
                if (e.$table.addClass("hasFilters"), f.searchTimer = null, f.filter_initTimer = null, 
                f.filter_formatterCount = 0, f.filter_formatterInit = [], f.filter_anyColumnSelector = '[data-column="all"],[data-column="any"]', 
                f.filter_multipleColumnSelector = '[data-column*="-"],[data-column*=","]', i = "\\{" + b.filter.regex.query + "\\}", 
                a.extend(p, {
                    child: new RegExp(e.cssChildRow),
                    ...
                    iQuery: new RegExp(i, "i"),
                    igQuery: new RegExp(i, "ig")
                }), f.filter_columnFilters !== !1 && e.$headers.filter(".filter-false, .parser-false").length !== e.$headers.length && b.filter.buildRow(d, e, f), 
                i = "addRows updateCell update updateRows updateComplete appendCache filterReset filterEnd search ".split(" ").join(e.namespace + "filter "), 
                e.$table.bind(i, function(g, h) {
                    return m = f.filter_hideEmpty && a.isEmptyObject(e.cache) && !(e.delayInit && "appendCache" === g.type), 
                    e.$table.find("." + c.filterRow).toggleClass(f.filter_filteredRow, m), /(search|filter)/.test(g.type) || (g.stopPropagation(), 
                    b.filter.buildDefault(d, !0)), "filterReset" === g.type ? (e.$table.find("." + c.filter).add(f.filter_$externalFilters).val(""), 
                    b.filter.searching(d, [])) : "filterEnd" === g.type ? b.filter.buildDefault(d, !0) : (h = "search" === g.type ? h : "updateComplete" === g.type ? e.$table.data("lastSearch") : "", 
                    /(update|add)/.test(g.type) && "updateComplete" !== g.type && (e.lastCombinedFilter = null, 
                    e.lastSearch = []), b.filter.searching(d, h, !0)), !1;
                }), f.filter_reset && (f.filter_reset instanceof a ? f.filter_reset.click(function() {
                    e.$table.trigger("filterReset");
                }) : a(f.filter_reset).length && a(document).undelegate(f.filter_reset, "click.tsfilter").delegate(f.filter_reset, "click.tsfilter", function() {
                    e.$table.trigger("filterReset");
                })), f.filter_functions) for (k = 0; k < e.columns; k++) if (n = b.getColumnData(d, f.filter_functions, k)) if (j = e.$headerIndexed[k].removeClass("filter-select"), 
                o = !(j.hasClass("filter-false") || j.hasClass("parser-false")), g = "", n === !0 && o) b.filter.buildSelect(d, k); else if ("object" == typeof n && o) {
                    for (h in n) "string" == typeof h && (g += "" === g ? '<option value="">' + (j.data("placeholder") || j.attr("data-placeholder") || f.filter_placeholder.select || "") + "</option>" : "", 
                ...
                e.showProcessing && e.$table.unbind("filterStart filterEnd ".split(" ").join(e.namespace + "filter ").replace(/\s+/g, " ")).bind("filterStart filterEnd ".split(" ").join(e.namespace + "filter "), function(f, g) {
                    j = g ? e.$table.find("." + c.header).filter("[data-column]").filter(function() {
                        return "" !== g[a(this).data("column")];
                    }) : "", b.isProcessing(d, "filterStart" === f.type, g ? j : "");
                }), e.filteredRows = e.totalRows, e.$table.unbind("tablesorter-initialized pagerBeforeInitialized ".split(" ").join(e.namespace + "filter ").replace(/\s+/g, " ")).bind("tablesorter-initialized pagerBeforeInitialized ".split(" ").join(e.namespace + "filter "), function() {
                    var a = this.config.widgetOptions;
                    l = b.filter.setDefaults(d, e, a) || [], l.length && (e.delayInit && "" === l.join("") || b.setFilters(d, l, !0)), 
                    e.$table.trigger("filterFomatterUpdate"), setTimeout(function() {
                        a.filter_initialized || b.filter.filterInitComplete(e);
                    }, 100);
                }), e.pager && e.pager.initialized && !f.filter_initialized && (e.$table.trigger("filterFomatterUpdate"), 
                setTimeout(function() {
                    b.filter.filterInitComplete(e);
                }, 100));
            },
            ...
            filterInitComplete: function(c) {
                var d, e, f = c.widgetOptions, g = 0, h = function() {
                    f.filter_initialized = !0, c.$table.trigger("filterInit", c), b.filter.findRows(c.table, c.$table.data("lastSearch") || []);
                };
            ...
            setDefaults: function(c, d, e) {
                ...
                f = a.isArray(g), f && "" === g.join("") || !f || (k = g)), "" === k.join("")) for (j = d.$headers.add(e.filter_$externalFilters).filter("[" + e.filter_defaultAttrib + "]"), 
                h = 0; h <= d.columns; h++) i = h === d.columns ? "all" : h, k[h] = j.filter('[data-column="' + i + '"]').attr(e.filter_defaultAttrib) || k[h] || "";
                return d.$table.data("lastSearch", k), k;
            },
            parseFilter: function(a, b, c, d, e) {
                return e || d ? a.parsers[c].format(b, a.table, [], c) : b;
            },
            buildRow: function(d, e, f) {
                var g, h, i, j, k, l, m, n = e.columns, o = a.isArray(f.filter_cellFilter), p = '<tr role="row" class="' + c.filterRow + " " + e.cssIgnoreRow + '">';
                for (h = 0; n > h; h++) p += o ? "<td" + (f.filter_cellFilter[h] ? ' class="' + f.filter_cellFilter[h] + '"' : "") + "></td>" : "<td" + ("" !== f.filter_cellFilter ? ' class="' + f.filter_cellFilter + '"' : "") + "></td>";
                for (e.$filters = a(p += "</tr>").appendTo(e.$table.children("thead").eq(0)).find("td"), 
                h = 0; n > h; h++) k = !1, i = e.$headerIndexed[h], m = b.getColumnData(d, f.filter_functions, h), 
                j = f.filter_functions && m && "function" != typeof m || i.hasClass("filter-select"), 
                g = b.getColumnData(d, e.headers, h), k = "false" === b.getData(i[0], g, "filter") || "false" === b.getData(i[0], g, "parser"), 
                j ? p = a("<select>").appendTo(e.$filters.eq(h)) : (m = b.getColumnData(d, f.filter_formatter, h), 
                m ? (f.filter_formatterCount++, p = m(e.$filters.eq(h), h), p && 0 === p.length && (p = e.$filters.eq(h).children("input")), 
                p && (0 === p.parent().length || p.parent().length && p.parent()[0] !== e.$filters[h]) && e.$filters.eq(h).append(p)) : p = a('<input type="search">').appendTo(e.$filters.eq(h)), 
                p && p.attr("placeholder", i.data("placeholder") || i.attr("data-placeholder") || f.filter_placeholder.search || "")), 
                p && (l = (a.isArray(f.filter_cssFilter) ? "undefined" != typeof f.filter_cssFilter[h] ? f.filter_cssFilter[h] || "" : "" : f.filter_cssFilter) || "", 
                p.addClass(c.filter + " " + l).attr("data-column", h), k && (p.attr("placeholder", "").addClass(c.filterDisabled)[0].disabled = !0));
            },
            ...
            checkFilters: function(d, e, f) {
                ...
                return a.isEmptyObject(g.cache) ? void (g.delayInit && g.pager && g.pager.initialized && g.$table.trigger("updateCache", [ function() {
                    b.filter.checkFilters(d, !1, f);
                } ])) : (i && (b.setFilters(d, j, !1, f !== !0), h.filter_initialized || (g.lastCombinedFilter = "")), 
                h.filter_hideFilters && g.$table.find("." + c.filterRow).trigger("" === k ? "mouseleave" : "mouseenter"), 
                g.lastCombinedFilter !== k || e === !1 ? (e === !1 && (g.lastCombinedFilter = null, 
                g.lastSearch = []), h.filter_initialized && g.$table.trigger("filterStart", [ j ]), 
                g.showProcessing ? void setTimeout(function() {
                    return b.filter.findRows(d, j, k), !1;
                }, 30) : (b.filter.findRows(d, j, k), !1)) : void 0);
            },
            hideFilters: function(d, e) {
                var f, g, h;
                a(d).find("." + c.filterRow).addClass(c.filterRowHide).bind("mouseenter mouseleave", function(b) {
                    var d = b;
                    f = a(this), clearTimeout(h), h = setTimeout(function() {
                        /enter|over/.test(d.type) ? f.removeClass(c.filterRowHide) : a(document.activeElement).closest("tr")[0] !== f[0] && "" === e.lastCombinedFilter && f.addClass(c.filterRowHide);
                    }, 200);
                }).find("input, select").bind("focus blur", function(d) {
                    g = a(this).closest("tr"), clearTimeout(h);
                    var f = d;
                    h = setTimeout(function() {
                        "" === b.getFilters(e.$table).join("") && g["focus" === f.type ? "removeClass" : "addClass"](c.filterRowHide);
                    }, 200);
                });
            },
            ...
            multipleColumns: function(c, d) {
                ...
                if (o && /-/.test(q)) for (f = q.match(/(\d+)\s*-\s*(\d+)/g), m = f.length, l = 0; m > l; l++) {
                    for (g = f[l].split(/\s*-\s*/), h = parseInt(g[0], 10) || 0, i = parseInt(g[1], 10) || c.columns - 1, 
                    h > i && (e = h, h = i, i = e), i >= c.columns && (i = c.columns - 1); i >= h; h++) p.push(h);
                    q = q.replace(f[l], "");
                }
                if (o && /,/.test(q)) for (j = q.split(/\s*,\s*/), m = j.length, k = 0; m > k; k++) "" !== j[k] && (l = parseInt(j[k], 10), 
                l < c.columns && p.push(l));
                ...
                if (c.config.lastCombinedFilter !== e && c.config.widgetOptions.filter_initialized) {
                    ...
                    I.filteredRows = 0, I.totalRows = 0, e = (d || []).join(""), j = 0; j < I.$tbodies.length; j++) {
                        ...
                        h = a(a.map(g, function(a) {
                            return a[n].$row.get();
                        })), "" === e || J.filter_serversideFiltering) h.removeClass(J.filter_filteredRow).not("." + I.cssChildRow).css("display", ""); else {
            ...
            getOptionSource: function(c, d, e) {
                c = a(c)[0];
                var f, g, h, i = c.config, j = i.widgetOptions, k = [], l = !1, m = j.filter_selectSource, n = i.$table.data("lastSearch") || [], o = a.isFunction(m) ? !0 : b.getColumnData(c, m, d);
                if (e && "" !== n[d] && (e = !1), o === !0) l = m(c, d, e); else {
                    if (o instanceof a || "string" === a.type(o) && o.indexOf("</option>") >= 0) return o;
                    a.isArray(o) ? l = o : "object" === a.type(m) && o && (l = o(c, d, e));
                }
                if (l === !1 && (l = b.filter.getOptions(c, d, e)), l = a.grep(l, function(b, c) {
                    return a.inArray(b, l) === c;
                }), i.$headerIndexed[d].hasClass("filter-select-nosort")) return l;
                for (h = l.length, g = 0; h > g; g++) k.push({
                    t: l[g],
                    p: i.parsers && i.parsers[d].format(l[g], c, [], d)
                });
                for (f = i.textSorter || "", k.sort(function(e, g) {
                ...
                }), l = [], h = k.length, g = 0; h > g; g++) l.push(k[g].t);
                return l;
            },
            getOptions: function(b, c, d) {
                ...
                e = 0; g > e; e++) h = i.row ? i.row[e] : i.normalized[e][k.columns].$row[0], d && h.className.match(l.filter_filteredRow) || (l.filter_useParsedData || k.parsers[c].parsed || k.$headerIndexed[c].hasClass("filter-parsed") ? m.push("" + i.normalized[e][c]) : (j = h.cells[c], 
            ...
            buildSelect: function(d, e, f, g, h) {
                if (d = a(d)[0], e = parseInt(e, 10), d.config.cache && !a.isEmptyObject(d.config.cache)) {
                    ...
                    if (("undefined" == typeof f || "" === f) && (f = b.filter.getOptionSource(d, e, h)), 
                    a.isArray(f)) {
                        for (i = 0; i < f.length; i++) k = f[i] = ("" + f[i]).replace(/\"/g, "&quot;"), 
                        j = k, k.indexOf(p.filter_selectSourceSeparator) >= 0 && (l = k.split(p.filter_selectSourceSeparator), 
                        j = l[0], k = l[1]), r += "" !== f[i] ? "<option " + (j === k ? "" : 'data-function-name="' + f[i] + '" ') + 'value="' + j + '">' + k + "</option>" : "";
                        f = [];
                    }
                    m = (o.$filters ? o.$filters : o.$table.children("thead")).find("." + c.filter), 
                    p.filter_$externalFilters && (m = m && m.length ? m.add(p.filter_$externalFilters) : p.filter_$externalFilters), 
                    n = m.filter('select[data-column="' + e + '"]'), n.length && (n[g ? "html" : "append"](r), 
                    a.isArray(f) || n.append(f).val(s), n.val(s));
                }
            },
            buildDefault: function(a, c) {
                var d, e, f, g = a.config, h = g.widgetOptions, i = g.columns;
                for (d = 0; i > d; d++) e = g.$headerIndexed[d], f = !(e.hasClass("filter-false") || e.hasClass("parser-false")), 
                (e.hasClass("filter-select") || b.getColumnData(a, h.filter_functions, d) === !0) && f && b.filter.buildSelect(a, d, "", c, e.hasClass(h.filter_onlyAvail));
            }
        }, b.getFilters = function(d, e, f, g) {
            var h, i, j, k, l = !1, m = d ? a(d)[0].config : "", n = m ? m.widgetOptions : "";
            if (e !== !0 && n && !n.filter_columnFilters) return a(d).data("lastSearch");
            ...
            j = i.filter(k), j.length && (j = b.filter.getLatestSearch(j), a.isArray(f) ? (g && j.slice(1), 
            h === m.columns && (k = j.filter(n.filter_anyColumnSelector), j = k.length ? k : j), 
            j.val(f[h]).trigger("change.tsfilter")) : (l[h] = j.val() || "", h === m.columns ? j.slice(1).filter('[data-column*="' + j.attr("data-column") + '"]').val(l[h]) : j.slice(1).val(l[h])), 
        ...
        a.extend(c.css, {
            ...
            format: function(d, e, f) {
                if (!(e.$table.hasClass("hasStickyHeaders") || a.inArray("filter", e.widgets) >= 0 && !e.$table.hasClass("hasFilters"))) {
                    ...
                    i.length && !i.css("position") && i.css("position", "relative"), t.attr("id") && (t[0].id += f.stickyHeaders_cloneId), 
                    t.find("thead:gt(0), tr.sticky-false").hide(), t.find("tbody, tfoot").remove(), 
                    t.find("caption").toggle(f.stickyHeaders_includeCaption), g = v.children().children(), 
                    t.css({
                        height: 0,
                        width: 0,
                        margin: 0
                        ...
                        z();
                    }), c.bindEvents(d, v.children().children("." + c.css.header)), h.after(u), e.onRenderHeader && v.children("tr").children().each(function(b) {
                        ...
                        if (h.is(":visible")) {
                            ...
                            var d = h.offset(), e = a.isWindow(k[0]), f = a.isWindow(l[0]), g = (i.length ? e ? k.scrollTop() : k.offset().top : k.scrollTop()) + q + s, j = h.height() - (u.height() + (o.height() || 0)), m = g > d.top && g < d.top + j ? "visible" : "hidden", n = {
                                visibility: m
                            };
                            i.length && (n.top = e ? g - i.offset().top : i.scrollTop()), f && (n.left = h.offset().left - parseInt(h.css("margin-left"), 10) - l.scrollLeft() - x), 
                            r.length && (n.top = (n.top || 0) + q + s), u.removeClass(c.css.stickyVis + " " + c.css.stickyHide).addClass("visible" === m ? c.css.stickyVis : c.css.stickyHide).css(n), 
        ...
        a.extend(c.css, {
            ...
            init: function(b, d) {
                if (!b.$table.hasClass("hasResizable")) {
                    b.$table.addClass("hasResizable"), c.resizableReset(b.table, !0), d.resizable_ = {
                        $wrap: b.$table.parent(),
                        mouseXPosition: 0,
                        $target: null,
                        $next: null,
                        overflow: "auto" === b.$table.parent().css("overflow"),
                        fullWidth: Math.abs(b.$table.parent().width() - b.$table.width()) < 20,
                        storedSizes: []
                    };
                    var e, f, g, h, i = parseInt(b.$table.css("margin-top"), 10);
                    for (d.resizable_.storedSizes = h = (c.storage && d.resizable !== !1 ? c.storage(b.table, c.css.resizableStorage) : []) || [], 
                    c.resizable.setWidths(b, d, h), d.$resizable_container = a('<div class="' + c.css.resizableContainer + '">').css({
                        top: i
                    }).insertBefore(b.$table), g = 0; g < b.columns; g++) f = b.$headerIndexed[g], e = "false" === c.getData(f, c.getColumnData(b.table, b.headers, g), "resizable"), 
                    e || a('<div class="' + c.css.resizableHandle + '">').appendTo(d.$resizable_container).attr({
                        "data-column": g,
                        unselectable: "on"
                    }).data("header", f).bind("selectstart", !1);
                    b.$table.one("tablesorter-initialized", function() {
            ...
            toggleTextSelection: function(b, d) {
                ...
                b.widgetOptions.resizable_.disabled = d, a("body").toggleClass(c.css.resizableNoSelect, d), 
                d ? a("body").attr("unselectable", "on").bind("selectstart" + e, !1) : a("body").removeAttr("unselectable").unbind("selectstart" + e);
            },
            bindings: function(d, e) {
                ...
                e.$resizable_container.children().bind("mousedown", function(b) {
                    ...
                    e.resizable_.disabled && (c.resizable.toggleTextSelection(d, !1), c.resizable.stopResize(d, e), 
            ...
            remove: function(b, d, e) {
                if (e.$resizable_container) {
                    var f = d.namespace + "tsresize";
                    d.$table.add(a(d.namespace + "_extra_table")).removeClass("hasResizable").children("thead").unbind("contextmenu" + f), 
                    e.$resizable_container.remove(), c.resizable.toggleTextSelection(d, !1), c.resizableReset(b), 
                    a(document).unbind("mousemove" + f + " mouseup" + f);
                }
            }
