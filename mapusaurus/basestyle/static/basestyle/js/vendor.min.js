!function(a, b) {
    ...
    return function(a) {
        ...
        var b = a.tablesorter = {
            ...
            setHeadersCss: function(c) {
                var d, e, f, g = c.sortList, h = g.length, i = b.css.sortNone + " " + c.cssNone, j = [ b.css.sortAsc + " " + c.cssAsc, b.css.sortDesc + " " + c.cssDesc ], k = [ c.cssIconAsc, c.cssIconDesc, c.cssIconNone ], l = [ "ascending", "descending" ], m = c.$table.find("tfoot tr").add(a(c.namespace + "_extra_headers").children("tr")).children("td, th").removeClass(j.join(" "));
    ...
    return function(a, b, c) {
        ...
        "use strict";
        var b, c, d = a.tablesorter || {}, e = d.css;
        a.extend(e, {
            ...
            bindSearch: function(c, e, f) {
                if (c = a(c)[0], e = a(e), e.length) {
                    var g, h = c.config, i = h.widgetOptions, j = h.namespace + "filter", k = i.filter_$externalFilters;
                    f !== !0 && (g = i.filter_anyColumnSelector + "," + i.filter_multipleColumnSelector, 
                    i.filter_$anyMatch = e.filter(g), k && k.length ? i.filter_$externalFilters = i.filter_$externalFilters.add(e) : i.filter_$externalFilters = e, 
                    d.setFilters(c, h.$table.data("lastSearch") || [], f === !1)), g = "keypress keyup search change ".split(" ").join(j + " "), 
                    e.attr("data-lastSearchTime", new Date().getTime()).unbind(g.replace(d.regex.spaces, " ")).bind("keyup" + j, function(d) {
                        if (a(this).attr("data-lastSearchTime", new Date().getTime()), 27 === d.which) this.value = ""; else {
                            if (i.filter_liveSearch === !1) return;
                            if ("" !== this.value && ("number" == typeof i.filter_liveSearch && this.value.length < i.filter_liveSearch || 13 !== d.which && 8 !== d.which && (d.which < 32 || d.which >= 37 && d.which <= 40))) return;
                        }
                        b.searching(c, !0, !0);
                    }).bind("search change keypress ".split(" ").join(j + " "), function(d) {
                        var e = parseInt(a(this).attr("data-column"), 10);
                        i.filter_initialized && (13 === d.which || "search" === d.type || "change" === d.type && this.value !== h.lastSearch[e]) && (d.preventDefault(), 
                        a(this).attr("data-lastSearchTime", new Date().getTime()), b.searching(c, !1, !0));
                    });
                }
            },
