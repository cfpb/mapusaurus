!function($) {
    ...
    function buildTable(showPeers) {
        msaData.done(function() {
            ...
            msa = tableData.lender, msa.peers = tableData.peers, msa.odds = tableData.odds, 
            msa.counties = tableData.counties, msa.showPeers = showPeers, _.templateSettings.variable = "msa", 
            template = _.template($("script.table-template").html()), tbl = $(template(msa)), 
    ...
    var currentChart, tableData = {}, msaData = getTableData();
