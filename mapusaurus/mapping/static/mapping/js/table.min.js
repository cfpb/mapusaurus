...
function createTable(showPeers) {
    msaData.done(function(res) {
        tableData || (tableData = res.table_data, console.log("Table Data: ", tableData), 
...
!function($) {
    ...
    $("#data-container"), $("#plot-container"), $("#table-container");
    _.templateSettings.variable = "data";
    _.template($("script.thead-template").html()), _.template($("script.row-template").html());
});
