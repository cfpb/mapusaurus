...
$(document).ready(function() {
    ...
    rowTemplate = _.template($("script.row-template").html()), $(".chart-toggle").click(function(e) {
        ...
        return currentChart && destroyData(), "closeChart" === e.currentTarget.id ? (toggleDataContainer(!1), 
        currentChart = null, !1) : void (currentChart != id ? (createTable("chart-toggle__peer-table" === id), 
