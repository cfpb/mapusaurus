...
var msaArray = [], moveEndAction = {}, oldEndAction = "selected";
...
moveEndAction.selected = function() {
    ...
    "all_msa" === oldEndAction ? $.when(getMsasInBounds()).done(function(data) {
        ...
        intersect.length > 0 ? (initCalls(geoQueryType), oldEndAction = "all_msa") : 0 === intersect.length && (console.log("No call required - MSAs are the same"), 
