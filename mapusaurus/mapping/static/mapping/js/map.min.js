...
$(document).ready(function() {
    ...
    var keyHide = $(".hide-key"), keyShow = $(".show-key"), keyContents = $(".key-contents");
    keyHide.on("click", function(e) {
        keyShow.removeClass("hidden"), keyContents.addClass("hidden"), keyHide.addClass("hidden");
    }), keyShow.on("click", function(e) {
        keyHide.removeClass("hidden"), keyContents.removeClass("hidden"), keyShow.addClass("hidden");
