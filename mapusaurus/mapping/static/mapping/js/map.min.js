...
function toggleBranches(status) {
    status ? (drawBranches(), $("#lender-branches").addClass("green-highlight")) : (layers.Branches.clearLayers(), 
...
function drawMarker(data) {
    ...
    marker.on("mouseover mousemove", function(e) {
        this.setIcon(myIconHover), new L.Rrose({
            ...
            closeButton: !1,
            autoPan: !1
        }).setContent("<span>" + data.name + "</span><br/>" + data.city + "</span>").setLatLng(e.latlng).openOn(map);
    }), marker.on("mouseout mousemove", function() {
        this.setIcon(myIcon);
