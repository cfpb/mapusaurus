...
function toggleSuper(status) {
    var url = $("#download_data").data("hierarchy_download_url"), origUrl = $("#download_data").data("download_url");
    status ? $("#download_data").attr("href", origUrl) : $("#download_data").attr("href", url);
}
...
window.console || (console = {
    ...
    "undefined" != typeof loadParams.lh) {
        ...
        console.log("load params status: ", status), $("#superSelect").prop("checked", status), 
        toggleSuper(status);
    }
    $("#superSelect").change(function() {
        var el = $("#superSelect"), status = el.prop("checked");
        toggleSuper(status), addParam("lh", status), init();
