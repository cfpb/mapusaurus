...
$(document).ready(function() {
    ...
    layerUpdate("inv_non_hisp_white_only_perc")), "undefined" != typeof loadParams.category) {
        var cat = loadParams.category.values;
        $("#" + cat).addClass("active"), layerUpdate(cat);
    }
    var mapDividerOptions = $(".map-divider-minor.option");
    mapDividerOptions.on("click", function(e) {
        mapDividerOptions.removeClass("active");
        var selectedOption = $(this), optionVal = selectedOption.attr("id");
        selectedOption.addClass("active"), addParam("category", optionVal), layerUpdate(optionVal), 
        console.log("THIS CHANGE FOR MINOR OPTION: ", $(this)), console.log("E FOR MINOR OPTION CHANGE: ", e);
