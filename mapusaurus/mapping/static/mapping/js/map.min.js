...
function createTractDataObj(callback) {
    ...
    dataStore.tracts = {}, _.each(rawGeo.features, function(feature) {
        ...
        count++;
    }), console.log("DataSTore Count: ", count), "function" == typeof callback && callback() && callback();
}
...
$(document).ready(function() {
    ...
    $("#geoTypeQuerySelector").change(function() {
        ...
        geoQueryType = el.val(), console.log("geoQueryType: ", geoQueryType), addParam("geo_query_type", geoQueryType);
    ...
    updateCensusLink(), layerUpdate($("#category-selector").val()), $(window).on("hashchange", function() {
        updatePrintLink(), updateCensusLink(), moveEndAction[geoQueryType]();
    }), initCalls(geoQueryType);
});

var msaArray = [], moveEndAction = {}, oldEndAction = "";

moveEndAction.selected = function() {
    "selected" === oldEndAction ? (console.log("No action required for 'selected' status. Nothing happens."), 
    oldEndAction = "selected") : (initCalls(geoQueryType), oldEndAction = "selected");
    ...
    }), oldEndAction = "all_msa") : (initCalls(geoQueryType), oldEndAction = "all_msa");
